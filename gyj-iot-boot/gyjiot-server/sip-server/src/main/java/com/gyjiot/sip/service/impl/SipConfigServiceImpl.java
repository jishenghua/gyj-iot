...
import com.gyjiot.sip.mapper.SipConfigMapper;
...
public class SipConfigServiceImpl implements ISipConfigService {
    ...
    public void updateDefaultSipConfig(SipConfig sipConfig) {
        ...
        redisCache.setCacheObject(GyjConstant.REDIS.DEFAULT_SIP_CONFIG, defConfig);
    }

    @Override
    public SipConfig GetDefaultSipConfig() {
        Object temp = redisCache.getCacheObject(GyjConstant.REDIS.DEFAULT_SIP_CONFIG);
