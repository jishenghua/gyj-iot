package com.gyjiot.server.config;

import com.gyjiot.common.constant.GyjConstant;
import com.gyjiot.common.enums.ServerType;
import com.gyjiot.server.Server;
import com.gyjiot.base.codec.Delimiter;
import com.gyjiot.base.codec.LengthField;
import com.gyjiot.base.codec.MessageDecoder;
import com.gyjiot.base.codec.MessageEncoder;
import com.gyjiot.base.core.HandlerInterceptor;
import com.gyjiot.base.core.HandlerMapping;
import com.gyjiot.base.session.SessionManager;
...
public class NettyConfig {
    ...
    public NettyConfig(int workerGroup,
        ...
        /*校验值是否正确*/
        ObjectUtil.checkNotNull(port, GyjConstant.SERVER.PORT);
        ObjectUtil.checkPositive(port, GyjConstant.SERVER.PORT);
