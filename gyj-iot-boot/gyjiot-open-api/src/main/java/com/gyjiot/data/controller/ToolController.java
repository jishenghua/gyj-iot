...
import com.gyjiot.common.ProtocolDeCodeService;
...
import com.gyjiot.common.core.iot.response.DeCodeBo;
import com.gyjiot.common.core.page.TableDataInfo;
import com.gyjiot.common.enums.BusinessType;
import com.gyjiot.common.exception.file.FileNameLengthLimitExceededException;
import com.gyjiot.common.utils.StringUtils;
import com.gyjiot.common.utils.file.FileUploadUtils;
import com.gyjiot.common.utils.file.FileUtils;
...
import com.gyjiot.iot.util.VelocityInitializer;
import com.gyjiot.iot.util.VelocityUtils;
import com.gyjiot.mq.model.ReportDataBo;
import com.gyjiot.mq.service.IMqttMessagePublish;
import com.gyjiot.mqttclient.MqttClientConfig;
...
import static com.gyjiot.common.utils.file.FileUploadUtils.getExtension;
...
//            }
    ...
    private void genSdk(HttpServletResponse response, byte[] data) throws IOException {
        ...
        response.setHeader("Content-Disposition", "attachment; filename=\"gyjiot.zip\"");
