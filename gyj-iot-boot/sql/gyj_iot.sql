...
CREATE TABLE `iot_category` (
  ...
  `category_name` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL COMMENT '产品分类名称',
  `tenant_id` bigint NOT NULL COMMENT '租户ID',
  `tenant_name` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '租户名称',
  ...
  KEY `iot_category_index_tenant_id` (`tenant_id`) USING BTREE,
  KEY `iot_category_index_parent_id` (`parent_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='产品分类';
...
CREATE TABLE `iot_device` (
  ...
  `device_name` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL COMMENT '设备名称',
  `product_id` bigint NOT NULL COMMENT '产品ID',
  `product_name` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL COMMENT '产品名称',
  `user_id` bigint NOT NULL COMMENT '用户ID',
  `user_name` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '用户昵称',
  `tenant_id` bigint NOT NULL COMMENT '租户ID',
  `tenant_name` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '租户名称',
  `serial_number` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL COMMENT '设备编号',
  `gw_dev_code` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '子设备网关编号',
  `firmware_version` float(11,2) NOT NULL COMMENT '固件版本',
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '设备状态（1-未激活，2-禁用，3-在线，4-离线）',
  `rssi` tinyint DEFAULT NULL COMMENT '信号强度（\r\n信号极好4格[-55— 0]，\r\n信号好3格[-70— -55]，\r\n信号一般2格[-85— -70]，\r\n信号差1格[-100— -85]）',
  `is_shadow` tinyint(1) DEFAULT NULL COMMENT '是否启用设备影子(0=禁用，1=启用)',
  `location_way` tinyint(1) DEFAULT NULL COMMENT '定位方式(1=ip自动定位，2=设备定位，3=自定义)',
  `things_model_value` json DEFAULT NULL COMMENT '物模型值',
  `network_address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '设备所在地址',
  `network_ip` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '设备入网IP',
  `longitude` double(11,6) DEFAULT NULL COMMENT '设备经度',
  `latitude` double(11,6) DEFAULT NULL COMMENT '设备纬度',
  `active_time` datetime DEFAULT NULL COMMENT '激活时间',
  `summary` json DEFAULT NULL COMMENT '设备摘要，格式[{"name":"device"},{"chip":"esp8266"}]',
  `img_url` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '图片地址',
  `del_flag` char(1) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT '0' COMMENT '删除标志（0代表存在 2代表删除）',
  `create_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT '' COMMENT '创建者',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT '' COMMENT '更新者',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='设备分组';
...
CREATE TABLE `iot_device_job` (
  ...
  `serial_number` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '设备编号',
  `device_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '设备名称',
  `is_advance` tinyint(1) DEFAULT NULL COMMENT '是否详细corn表达式（1=是，0=否）',
  `actions` json DEFAULT NULL COMMENT '执行的动作集合',
  `job_type` tinyint(1) DEFAULT NULL COMMENT '任务类型（1=设备定时，2=设备告警，3=场景联动）',
  `product_id` bigint DEFAULT NULL COMMENT '产品ID',
  `product_name` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '产品名称',
  `scene_id` bigint DEFAULT NULL COMMENT '场景联动ID',
  `alert_id` bigint DEFAULT NULL COMMENT '告警ID',
  `alert_trigger` json DEFAULT NULL COMMENT '定时告警触发器',
  PRIMARY KEY (`job_id`,`job_name`,`job_group`) USING BTREE,
  KEY `iot_device_job_index_device_id` (`device_id`) USING BTREE,
  KEY `iot_device_job_index_product_id` (`product_id`) USING BTREE,
  KEY `iot_device_job_index_scene_id` (`scene_id`) USING BTREE,
  KEY `iot_device_job_index_alert_id` (`alert_id`) USING BTREE,
  KEY `iot_device_job_index_serial_number` (`serial_number`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='设备定时';

-- ----------------------------
-- Records of iot_device_job
-- ----------------------------
INSERT INTO `iot_device_job` VALUES ('4', 'P', 'DEFAULT', '0 08 11 ? * 1,2,3,4,5,6,7', '2', '1', '0', 'admin', '2023-04-15 11:08:37', '', null, '', '108', 'D1ELV3A5TOJS', '★温湿度开关', '0', '[{\"id\": \"gear\", \"name\": \"运行档位\", \"type\": 2, \"value\": \"2\", \"deviceId\": 108, \"deviceName\": \"★温湿度开关\"}]', '1', '41', '★智能开关产品', null);
INSERT INTO `iot_device_job` VALUES ('5', '告警定时触发', 'DEFAULT', '0 13 11 ? * 1,2,3,4,5,6,7', '2', '1', '0', '', '2023-04-15 11:14:06', '', null, '', null, null, '告警定时触发', '0', '[{\"id\": \"gear\", \"name\": \"运行档位\", \"type\": 2, \"value\": \"1\", \"productId\": 96, \"productName\": \"★网关产品\"}]', '2', '96', '★网关产品', null);
...
CREATE TABLE `iot_device_log` (
  ...
  `identify` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL COMMENT '标识符',
  `model_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '物模型名称',
  `log_type` tinyint(1) NOT NULL COMMENT '类型（1=属性上报，2=调用功能，3=事件上报，4=设备升级，5=设备上线，6=设备离线）',
  `log_value` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL COMMENT '日志值',
  `device_id` bigint DEFAULT NULL COMMENT '设备ID',
  `device_name` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '设备名称',
  `serial_number` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '设备编号',
  ...
  `user_name` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT '' COMMENT '用户昵称',
  `tenant_id` bigint DEFAULT NULL COMMENT '租户ID',
  `tenant_name` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT '' COMMENT '租户名称',
  `create_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT '' COMMENT '创建者',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='设备日志';
...
CREATE TABLE `iot_device_template` (
  ...
  `product_id` bigint DEFAULT NULL COMMENT '产品id',
  `template_id` bigint DEFAULT NULL COMMENT '采集点模板id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='设备采集点模板关联对象';
...
CREATE TABLE `iot_device_user` (
  ...
  `tenant_name` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '租户名称',
  `device_name` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL COMMENT '设备名称',
  `phonenumber` varchar(11) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '手机号码',
  `user_name` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '用户昵称',
  `is_owner` tinyint NOT NULL COMMENT '是否为设备所有者（0=否，1=是）',
  `perms` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '用户物模型权限，多个以英文逗号分隔',
  `del_flag` char(1) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT '0' COMMENT '删除标志（0代表存在 2代表删除）',
  `create_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT '' COMMENT '创建者',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT '' COMMENT '更新者',
  ...
  KEY `iot_device_user_index_user_id` (`user_id`) USING BTREE,
  KEY `iot_device_user_index_tenant_id` (`tenant_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='设备用户';
...
INSERT INTO `iot_device_user` VALUES ('109', '3', '1', 'admin', '★网关设备', '15888888881', 'gyjiot-t2', '0', 'ota,timer,log,monitor,statistic,reset,gear,switch', '0', '', '2023-09-03 01:17:03', '', '2023-09-03 11:05:06', null);
...
CREATE TABLE `iot_event_log` (
  ...
  `remark` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`log_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='事件日志';
...
CREATE TABLE `iot_function_log` (
  ...
  `identify` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci NOT NULL COMMENT '标识符',
  `fun_type` int NOT NULL COMMENT '1==服务下发，2=属性获取，3.OTA升级',
  `fun_value` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci NOT NULL COMMENT '日志值',
  `message_id` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '消息id',
  `device_name` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '设备名称',
  `serial_number` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci NOT NULL COMMENT '设备编号',
  `mode` int DEFAULT NULL COMMENT '模式(1=影子模式，2=在线模式，3=其他)',
  `user_id` bigint DEFAULT NULL COMMENT '用户id',
  `result_msg` varchar(128) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '下发结果描述',
  `result_code` int DEFAULT NULL COMMENT '下发结果代码',
  `create_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '创建者',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `remark` varchar(128) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '备注',
  `show_value` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '显示值',
  `model_name` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '物模型名称',
  `reply_time` datetime DEFAULT NULL COMMENT '设备回复时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `iot_function_log_id_uindex` (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='设备服务下发日志';
...
CREATE TABLE `iot_group` (
  ...
  `group_name` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL COMMENT '分组名称',
  ...
  KEY `iot_group_index_user_id` (`user_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='设备分组';
...
CREATE TABLE `iot_product` (
  ...
  `product_name` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL COMMENT '产品名称',
  `protocol_code` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '协议编号',
  ...
  `mqtt_account` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'mqtt账号',
  `mqtt_password` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'mqtt密码',
  `mqtt_secret` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '产品秘钥',
  `status` tinyint(1) DEFAULT NULL COMMENT '状态（1-未发布，2-已发布）',
  `things_models_json` json DEFAULT NULL COMMENT '物模型JSON（属性、功能、事件）',
  `device_type` tinyint(1) DEFAULT '1' COMMENT '设备类型（1-直连设备、2-网关设备、3-监控设备）',
  `network_method` tinyint(1) DEFAULT '1' COMMENT '联网方式（1=wifi、2=蜂窝(2G/3G/4G/5G)、3=以太网、4=其他）',
  `vertificate_method` tinyint(1) DEFAULT '1' COMMENT '认证方式（1-简单认证、2-加密认证、3-简单+加密）',
  `img_url` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '图片地址',
  `del_flag` char(1) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT '0' COMMENT '删除标志（0代表存在 2代表删除）',
  `create_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT '' COMMENT '创建者',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
...
CREATE TABLE `iot_product_authorize` (
  ...
  `product_id` bigint NOT NULL COMMENT '产品ID',
  `device_id` bigint DEFAULT NULL COMMENT '设备ID',
  `serial_number` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '设备编号',
  `user_id` bigint DEFAULT NULL COMMENT '用户ID',
  `user_name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '用户名称',
  `status` tinyint(1) DEFAULT NULL COMMENT '状态（1-未使用，2-使用中）',
  `del_flag` char(1) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '删除标志（0代表存在 2代表删除）',
  `create_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT '' COMMENT '更新者',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `remark` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`authorize_id`) USING BTREE,
  KEY `iot_product_authorize_index_product_id` (`product_id`) USING BTREE,
  KEY `iot_product_authorize_index_device_id` (`device_id`) USING BTREE,
  KEY `iot_product_authorize_index_serial_number` (`serial_number`) USING BTREE,
  KEY `iot_product_authorize_index_user_id` (`user_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='产品授权码表';
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='协议表';
...
CREATE TABLE `iot_scene` (
  ...
  `scene_name` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL COMMENT '场景名称',
  `chain_name` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '规则名称',
  `enable` tinyint(1) DEFAULT NULL COMMENT '场景状态（1-启动，2-停止）',
  `user_id` bigint NOT NULL COMMENT '用户ID',
  `user_name` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL COMMENT '用户名称',
  `silent_period` int DEFAULT NULL COMMENT '静默周期（分钟）',
  `cond` tinyint DEFAULT NULL COMMENT '执行条件（1=或、任意条件，2=且、所有条件，3=非，不满足）',
  `execute_mode` tinyint(1) DEFAULT NULL COMMENT '执行方式（1=串行，顺序执行，2=并行，同时执行）',
  `execute_delay` int DEFAULT NULL COMMENT '延时执行（秒钟）',
  `has_alert` tinyint(1) DEFAULT '0' COMMENT '是否包含告警推送（1=包含，2=不包含）',
  `application_name` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '应用名称',
  `el_data` text CHARACTER SET utf8mb3 COLLATE utf8_general_ci COMMENT '规则数据',
  `create_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT '' COMMENT '创建者',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT '' COMMENT '更新者',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  ...
  KEY `iot_scene_index_user_id` (`user_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='场景联动';
...
CREATE TABLE `iot_scene_script` (
  `script_id` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci NOT NULL COMMENT '脚本ID',
  ...
  `product_id` bigint DEFAULT NULL COMMENT '产品ID（用于获取对应物模型）',
  `product_name` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '产品名称',
  `id` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '物模型标识符',
  `name` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '物模型名称',
  `value` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '物模型值',
  `operator` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '操作符',
  `type` tinyint(1) DEFAULT NULL COMMENT '物模型类别（1=属性，2=功能，3=事件，4=设备升级，5=设备上线，6=设备下线）',
  `device_count` int DEFAULT NULL COMMENT '设备数量',
  `job_id` bigint DEFAULT NULL COMMENT '任务ID',
  `cron_expression` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '' COMMENT 'cron执行表达式',
  `is_advance` tinyint(1) DEFAULT NULL COMMENT '是否详细corn表达式（1=是，0=否）',
  `parent_id` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '父物模id',
  `parent_name` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '父物模名称',
  `array_index` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '数组索引',
  `array_index_name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '数组索引名称',
  `create_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT '' COMMENT '创建者',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`script_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='场景脚本';
...
CREATE TABLE `iot_script` (
  `script_id` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '脚本ID',
  `user_id` bigint NOT NULL COMMENT '用户ID',
  `user_name` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '用户昵称',
  `scene_id` bigint NOT NULL DEFAULT '0' COMMENT '关联场景ID',
  `product_id` bigint DEFAULT NULL COMMENT '产品ID',
  `product_name` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '产品名称',
  ...
  `application_name` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '应用名，后端、规则和脚本要统一',
  `script_name` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '脚本名',
  `script_data` text CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL COMMENT '脚本数据',
  `script_type` char(16) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '脚本类型：\r\nscript=普通脚本，\r\nswitch_script=选择脚本，\r\nif_script=条件脚本，\r\nfor_script=数量循环脚本，\r\nwhile_script=条件循环，\r\nbreak_script=退出循环脚本',
  `script_language` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '脚本语言（groovy | qlexpress | js | python | lua | aviator | java）',
...
CREATE TABLE `iot_social_platform` (
  ...
  UNIQUE KEY `iot_social_platform_platform_uindex` (`platform`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='第三方登录平台控制';
...
CREATE TABLE `iot_social_user` (
  ...
  `access_token` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '用户的授权令牌',
  `expire_in` int DEFAULT NULL COMMENT '第三方用户的授权令牌的有效期（部分平台可能没有）',
  `refresh_token` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '刷新令牌(部分平台可能没有)',
  `open_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '第三方用户的 open id（部分平台可能没有）',
  `uid` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '第三方用户的 ID(部分平台可能没有)',
  `access_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '个别平台的授权信息（部分平台可能没有）',
  `union_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '第三方用户的 union id(部分平台可能没有)',
  `scope` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '第三方用户授予的权限(部分平台可能没有)',
  `token_type` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '个别平台的授权信息（部分平台可能没有）',
  `id_token` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'id token（部分平台可能没有）',
  `mac_algorithm` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '小米平台用户的附带属性（部分平台可能没有）',
  `mac_key` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '小米平台用户的附带属性(部分平台可能没有)',
  `code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '用户的授权code（部分平台可能没有）',
  `oauth_token` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Twitter平台用户的附带属性(部分平台可能没有)',
  `oauth_token_secret` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Twitter平台用户的附带属性(部分平台可能没有)',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `create_by` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '创建者',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `update_by` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '更新者',
  ...
  `avatar` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '用户头像',
  `gender` tinyint DEFAULT NULL COMMENT '用户性别',
  `source_client` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '第三方用户来源客户端（web、app、小程序）',
  PRIMARY KEY (`social_user_id`) USING BTREE,
  UNIQUE KEY `iot_social_user_pk` (`social_user_id`) USING BTREE,
  UNIQUE KEY `iot_social_user_unique_key` (`uuid`,`source`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=211 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='第三方登录用户';
...
CREATE TABLE `iot_things_model` (
  ...
  `model_name` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL COMMENT '物模型名称',
  `product_id` bigint NOT NULL COMMENT '产品ID',
  `product_name` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL COMMENT '产品名称',
  `tenant_id` bigint NOT NULL COMMENT '租户ID',
  `tenant_name` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '租户名称',
  `identifier` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL COMMENT '标识符，产品下唯一',
  `type` tinyint(1) NOT NULL COMMENT '模型类别（1-属性，2-功能，3-事件）',
  `datatype` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL COMMENT '数据类型（integer、decimal、string、bool、array、enum）',
  `specs` json DEFAULT NULL COMMENT '数据定义',
  ...
  `is_history` tinyint(1) DEFAULT '0' COMMENT '是否历史存储（0-否，1-是）',
  `is_readonly` tinyint(1) DEFAULT '0' COMMENT '是否只读数据(0-否，1-是)',
  `is_share_perm` tinyint(1) DEFAULT '0' COMMENT '是否设备分享权限(0-否，1-是)',
  `model_order` int DEFAULT '0' COMMENT '排序，值越大，排序越靠前',
  `del_flag` char(1) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT '0' COMMENT '删除标志（0代表存在 2代表删除）',
  `create_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT '' COMMENT '创建者',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT '' COMMENT '更新者',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `remark` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '备注',
  `temp_slave_id` bigint DEFAULT NULL COMMENT '从机id',
  `formula` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '计算公式',
  `reverse_formula` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '控制公式',
  `reg_addr` int DEFAULT NULL COMMENT '寄存器地址值',
  `bit_option` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '位定义选项',
  `value_type` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '解析类型 1.数值 2.选项',
  `is_params` int DEFAULT NULL COMMENT '是否是计算参数',
  `quantity` int DEFAULT NULL COMMENT '读取寄存器数量',
  `code` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'modbus功能码',
  `parse_type` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'modbus解析类型',
  PRIMARY KEY (`model_id`) USING BTREE,
  KEY `iot_things_model_index_product_id` (`product_id`) USING BTREE,
  KEY `iot_things_model_index_tenant_id` (`tenant_id`) USING BTREE,
  KEY `iot_things_model_index_model_order` (`model_order`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=510 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='物模型';

-- ----------------------------
-- Records of iot_things_model
-- ----------------------------
INSERT INTO `iot_things_model` VALUES ('113', '设备开关', '41', '温湿度智能开关', '1', 'admin', 'switch', '2', 'bool', '{\"type\": \"bool\", \"trueText\": \"打开\", \"falseText\": \"关闭\"}', '0', '0', '1', '0', '0', '9', '0', null, '2022-08-14 00:06:53', '', '2023-03-31 23:43:43', null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model` VALUES ('125', '空气温度', '41', '温湿度智能开关', '1', 'admin', 'temperature', '1', 'decimal', '{\"max\": 120, \"min\": -20, \"step\": 0.1, \"type\": \"decimal\", \"unit\": \"℃\"}', '1', '1', '1', '1', '0', '1', '0', null, '2022-11-05 23:56:21', '', '2023-03-31 23:44:21', null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model` VALUES ('126', '空气湿度', '41', '温湿度智能开关', '1', 'admin', 'humidity', '1', 'decimal', '{\"max\": 100, \"min\": 0, \"step\": 0.1, \"type\": \"decimal\", \"unit\": \"%\"}', '1', '1', '1', '1', '0', '3', '0', null, '2022-11-05 23:56:21', '', '2023-03-31 23:44:12', null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model` VALUES ('127', '二氧化碳', '41', '温湿度智能开关', '1', 'admin', 'co2', '1', 'integer', '{\"max\": 6000, \"min\": 100, \"step\": 1, \"type\": \"integer\", \"unit\": \"ppm\"}', '1', '1', '1', '1', '0', '2', '0', null, '2022-11-05 23:56:21', '', '2023-03-31 23:44:17', null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model` VALUES ('128', '室内亮度', '41', '温湿度智能开关', '1', 'admin', 'brightness', '1', 'integer', '{\"max\": 10000, \"min\": 0, \"step\": 1, \"type\": \"integer\", \"unit\": \"cd/m2\"}', '1', '1', '1', '1', '0', '4', '0', null, '2022-11-05 23:56:21', '', '2023-03-31 23:44:08', null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model` VALUES ('129', '运行档位', '41', '温湿度智能开关', '1', 'admin', 'gear', '2', 'enum', '{\"type\": \"enum\", \"showWay\": \"select\", \"enumList\": [{\"text\": \"低速档位\", \"value\": \"0\"}, {\"text\": \"中速档位\", \"value\": \"1\"}, {\"text\": \"中高速档位\", \"value\": \"2\"}, {\"text\": \"高速档位\", \"value\": \"3\"}]}', '0', '0', '1', '0', '0', '8', '0', null, '2022-11-05 23:56:21', '', '2023-03-31 23:43:49', null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model` VALUES ('130', '灯光色值', '41', '温湿度智能开关', '1', 'admin', 'light_color', '2', 'array', '{\"type\": \"array\", \"arrayType\": \"integer\", \"arrayCount\": \"3\"}', '0', '0', '1', '0', '0', '5', '0', null, '2022-11-05 23:56:21', '', '2023-09-25 22:57:42', null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model` VALUES ('131', '屏显消息', '41', '温湿度智能开关', '1', 'admin', 'message', '2', 'string', '{\"type\": \"string\", \"maxLength\": 1024}', '0', '0', '1', '0', '0', '7', '0', null, '2022-11-05 23:56:21', '', '2023-03-31 23:43:54', null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model` VALUES ('132', '上报数据', '41', '温湿度智能开关', '1', 'admin', 'report_monitor', '2', 'integer', '{\"max\": 10, \"min\": 1, \"step\": 1, \"type\": \"integer\", \"unit\": \"次数\"}', '0', '0', '0', '0', '0', '10', '0', null, '2022-11-05 23:56:21', '', '2023-03-31 23:43:38', null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model` VALUES ('134', '环境温度过高', '41', '温湿度智能开关', '1', 'admin', 'height_temperature', '3', 'decimal', '{\"max\": 100, \"min\": 0, \"step\": 0.1, \"type\": \"decimal\", \"unit\": \"℃\"}', '0', '0', '1', '0', '0', '0', '0', null, '2022-11-05 23:56:29', '', '2023-03-31 23:44:25', null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model` VALUES ('135', '设备发生异常', '41', '温湿度智能开关', '1', 'admin', 'exception', '3', 'string', '{\"type\": \"string\", \"maxLength\": 1024}', '0', '0', '1', '0', '0', '0', '0', null, '2022-11-05 23:56:29', '', '2023-03-31 23:44:29', null, null, null, null, null, null, null, null, null, null);
...
INSERT INTO `iot_things_model` VALUES ('162', '功能分组', '96', '网关产品', '1', 'admin', 'category', '1', 'object', '{\"type\": \"object\", \"params\": [{\"id\": \"category_light\", \"name\": \"光照\", \"order\": 1, \"isChart\": 1, \"datatype\": {\"max\": 100, \"min\": 0, \"step\": 1, \"type\": \"decimal\", \"unit\": \"mm\"}, \"isHistory\": 1, \"isMonitor\": 1, \"isReadonly\": 1}, {\"id\": \"category_humidity\", \"name\": \"空气湿度\", \"order\": 2, \"isChart\": 1, \"datatype\": {\"max\": 100, \"min\": 0, \"step\": 0.1, \"type\": \"decimal\", \"unit\": \"%\"}, \"isHistory\": 0, \"isMonitor\": 1, \"isReadonly\": 1}, {\"id\": \"category_temperature\", \"name\": \"空气温度-只读\", \"order\": 3, \"isChart\": 0, \"datatype\": {\"max\": 120, \"min\": -20, \"step\": 0.1, \"type\": \"decimal\", \"unit\": \"℃\"}, \"isHistory\": 1, \"isMonitor\": 0, \"isReadonly\": 1}, {\"id\": \"category_report_monitor\", \"name\": \"上报监测数据\", \"order\": 7, \"isChart\": 0, \"datatype\": {\"max\": 10, \"min\": 1, \"step\": 1, \"type\": \"integer\", \"unit\": \"次数\"}, \"isHistory\": 1, \"isMonitor\": 0, \"isReadonly\": 0, \"isSharePerm\": 1}, {\"id\": \"category_gear\", \"name\": \"运行档位\", \"order\": 5, \"isChart\": 0, \"datatype\": {\"type\": \"enum\", \"enumList\": [{\"text\": \"低速档位\", \"value\": \"0\"}, {\"text\": \"中速档位\", \"value\": \"1\"}, {\"text\": \"中高速档位\", \"value\": \"2\"}, {\"text\": \"高速档位\", \"value\": \"3\"}]}, \"isHistory\": 1, \"isMonitor\": 0, \"isReadonly\": 0, \"isSharePerm\": 1}, {\"id\": \"category_switch\", \"name\": \"设备开关\", \"order\": 4, \"isChart\": 0, \"datatype\": {\"type\": \"bool\", \"trueText\": \"打开\", \"falseText\": \"关闭\"}, \"isHistory\": 1, \"isMonitor\": 0, \"isReadonly\": 0, \"isSharePerm\": 1}, {\"id\": \"category_irc\", \"name\": \"射频遥控\", \"order\": 6, \"isChart\": 0, \"datatype\": {\"type\": \"enum\", \"showWay\": \"button\", \"enumList\": [{\"text\": \"遥控配对\", \"value\": \"FFXX01\"}, {\"text\": \"遥控清码\", \"value\": \"FFXX02\"}, {\"text\": \"打开开关\", \"value\": \"FFXX03\"}, {\"text\": \"关闭开关\", \"value\": \"FFXX04\"}, {\"text\": \"暂停\", \"value\": \"FFXX05\"}, {\"text\": \"锁定\", \"value\": \"FFXX06\"}]}, \"isHistory\": 1, \"isMonitor\": 0, \"isReadonly\": 0, \"isSharePerm\": 1}]}', '0', '0', '0', '0', '1', '9', '0', null, '2023-02-25 22:51:53', '', '2023-09-03 11:03:24', null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model` VALUES ('163', '空气温度', '96', '网关产品', '1', 'admin', 'temperature', '1', 'decimal', '{\"max\": 120, \"min\": -20, \"step\": 0.1, \"type\": \"decimal\", \"unit\": \"℃\"}', '1', '1', '1', '1', '0', '0', '0', null, '2023-02-25 22:52:16', '', '2023-03-31 16:08:03', null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model` VALUES ('164', '设备开关', '96', '网关产品', '1', 'admin', 'switch', '2', 'bool', '{\"type\": \"bool\", \"trueText\": \"打开\", \"falseText\": \"关闭\"}', '0', '0', '1', '0', '1', '8', '0', null, '2023-02-25 22:52:16', '', '2023-09-03 11:03:30', null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model` VALUES ('165', '运行档位', '96', '网关产品', '1', 'admin', 'gear', '2', 'enum', '{\"type\": \"enum\", \"showWay\": \"select\", \"enumList\": [{\"text\": \"低速档位\", \"value\": \"0\"}, {\"text\": \"中速档位\", \"value\": \"1\"}, {\"text\": \"中高速档位\", \"value\": \"2\"}, {\"text\": \"高速档位\", \"value\": \"3\"}]}', '0', '0', '1', '0', '1', '7', '0', null, '2023-02-25 22:52:16', '', '2023-09-03 11:03:41', null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model` VALUES ('166', '灯光色值', '96', '网关产品', '1', 'admin', 'light_color', '2', 'array', '{\"type\": \"array\", \"arrayType\": \"integer\", \"arrayCount\": \"3\"}', '0', '0', '1', '0', '0', '0', '0', null, '2023-02-25 22:52:16', '', '2023-03-31 16:08:09', null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model` VALUES ('167', '上报监测数据', '96', '网关产品', '1', 'admin', 'report_monitor', '2', 'integer', '{\"max\": 10, \"min\": 1, \"step\": 1, \"type\": \"integer\", \"unit\": \"次数\"}', '0', '0', '1', '0', '1', '11', '0', null, '2023-02-25 22:52:16', '', '2023-09-03 11:03:11', null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model` VALUES ('168', '环境温度过高', '96', '网关产品', '1', 'admin', 'height_temperature', '3', 'decimal', '{\"max\": 100, \"min\": 0, \"step\": 0.1, \"type\": \"decimal\", \"unit\": \"℃\"}', '0', '0', '1', '0', '0', '0', '0', null, '2023-02-25 22:52:16', '', '2023-03-31 16:08:15', null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model` VALUES ('169', '设备发生异常', '96', '网关产品', '1', 'admin', 'exception', '3', 'string', '{\"type\": \"string\", \"maxLength\": 1024}', '0', '0', '1', '0', '0', '0', '0', null, '2023-02-25 22:52:16', '', '2023-03-31 16:08:20', null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model` VALUES ('170', '屏显消息', '96', '网关产品', '1', 'admin', 'message', '2', 'string', '{\"type\": \"string\", \"maxLength\": 1024}', '0', '0', '1', '0', '1', '0', '0', null, '2023-02-25 22:52:35', '', '2023-09-03 11:03:55', null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model` VALUES ('171', '设备重启', '96', '网关产品', '1', 'admin', 'reset', '2', 'enum', '{\"type\": \"enum\", \"showWay\": \"button\", \"enumList\": [{\"text\": \"重启\", \"value\": \"restart\"}]}', '0', '0', '1', '0', '1', '0', '0', null, '2023-02-25 22:52:35', '', '2023-09-03 11:03:48', null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model` VALUES ('174', '室内亮度', '96', '网关产品', '1', 'admin', 'brightness', '1', 'integer', '{\"max\": 10000, \"min\": 0, \"step\": 1, \"type\": \"integer\", \"unit\": \"cd/m2\"}', '1', '1', '1', '1', '0', '0', '0', null, '2023-02-26 00:56:39', '', '2023-09-03 10:40:55', null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model` VALUES ('175', '设备重启', '41', '智能开关', '1', 'admin', 'reset', '2', 'enum', '{\"type\": \"enum\", \"showWay\": \"button\", \"enumList\": [{\"text\": \"重启\", \"value\": \"restart\"}]}', '0', '0', '1', '0', '0', '6', '0', null, '2023-02-26 02:20:40', '', '2023-04-01 23:40:05', null, null, null, null, null, null, null, null, null, null);
...
INSERT INTO `iot_things_model` VALUES ('439', '上报状态', '41', '★智能开关产品', '1', 'admin', 'status', '2', 'enum', '{\"type\": \"enum\", \"showWay\": \"button\", \"enumList\": [{\"text\": \"更新状态\", \"value\": \"update_status\"}]}', '0', '0', '0', '0', '0', '12', '0', 'admin', '2023-04-13 01:39:31', '', '2023-04-13 01:39:42', null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model` VALUES ('493', '漏水值', '112', '★MODBUS协议产品', '1', 'admin', '0', '1', 'integer', '{\"max\": 100, \"min\": 1, \"step\": 1, \"type\": \"integer\", \"unit\": \"度\"}', '0', '0', '1', '0', '0', '0', '0', '', '2023-09-13 23:33:19', '', null, null, '1', null, null, '0', null, null, null, '1', '3');
INSERT INTO `iot_things_model` VALUES ('494', '温度', '112', '★MODBUS协议产品', '1', 'admin', '0', '1', 'integer', '{\"max\": 100, \"min\": 1, \"step\": 1, \"type\": \"integer\", \"unit\": \"°\"}', '0', '0', '1', '0', '0', '0', '0', '', '2023-09-13 23:33:19', '', null, null, '2', null, null, '0', null, null, null, '1', '3');
INSERT INTO `iot_things_model` VALUES ('495', '电量', '112', '★MODBUS协议产品', '1', 'admin', '1', '1', 'integer', '{\"max\": 100, \"min\": 1, \"step\": 1, \"type\": \"integer\", \"unit\": \"\"}', '0', '0', '1', '0', '0', '0', '0', '', '2023-09-13 23:33:19', '', null, null, '11', null, null, '1', null, null, null, '1', '3');
INSERT INTO `iot_things_model` VALUES ('496', '光照强度', '55', '网关产品', '1', 'admin', 'light_level', '1', 'integer', '{\"max\": 89.2, \"min\": 2.5, \"step\": 0.1, \"type\": \"integer\", \"unit\": \"L/g\"}', '1', '1', '1', '1', '0', '0', '0', 'admin', '2025-03-19 16:32:06', '', null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model` VALUES ('497', '状态灯色', '55', '网关产品', '1', 'admin', 'color', '2', 'enum', '{\"type\": \"enum\", \"showWay\": \"select\", \"enumList\": [{\"text\": \"红色\", \"value\": \"0\"}, {\"text\": \"绿色\", \"value\": \"1\"}, {\"text\": \"蓝色\", \"value\": \"2\"}, {\"text\": \"黄色\", \"value\": \"3\"}]}', '0', '0', '1', '0', '0', '0', '0', 'admin', '2025-03-19 16:32:06', '', null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model` VALUES ('498', '子设备', '55', '网关产品', '1', 'admin', 'device', '2', 'array', '{\"type\": \"array\", \"params\": [{\"id\": \"device_co2\", \"name\": \"二氧化碳\", \"order\": 0, \"isChart\": 1, \"datatype\": {\"max\": 6000, \"min\": 100, \"step\": 1, \"type\": \"integer\", \"unit\": \"ppm\", \"enumList\": [{\"text\": \"\", \"value\": \"\"}], \"arrayType\": \"int\"}, \"isHistory\": 1, \"isMonitor\": 1, \"isReadonly\": 1}, {\"id\": \"device_temperature\", \"name\": \"空气温度-只读\", \"order\": 4, \"isChart\": 0, \"datatype\": {\"max\": 120, \"min\": -20, \"step\": 0.1, \"type\": \"decimal\", \"unit\": \"℃\", \"enumList\": [{\"text\": \"\", \"value\": \"\"}], \"arrayType\": \"int\"}, \"isMonitor\": 0, \"isReadonly\": 1}, {\"id\": \"device_gear\", \"name\": \"运行档位\", \"order\": 6, \"datatype\": {\"type\": \"enum\", \"showWay\": \"select\", \"enumList\": [{\"text\": \"低速档位\", \"value\": \"0\"}, {\"text\": \"中速档位\", \"value\": \"1\"}, {\"text\": \"中高速档位\", \"value\": \"2\"}, {\"text\": \"高速档位\", \"value\": \"3\"}]}, \"isMonitor\": 0, \"isReadonly\": 0}, {\"id\": \"device_switch\", \"name\": \"设备开关\", \"order\": 5, \"datatype\": {\"type\": \"bool\", \"enumList\": [{\"text\": \"\", \"value\": \"\"}], \"trueText\": \"打开\", \"arrayType\": \"int\", \"falseText\": \"关闭\"}, \"isMonitor\": 0, \"isReadonly\": 0}, {\"id\": \"device_report_monitor\", \"name\": \"上报监测数据\", \"order\": 9, \"datatype\": {\"max\": 10, \"min\": 1, \"step\": 1, \"type\": \"integer\", \"unit\": \"次数\", \"enumList\": [{\"text\": \"\", \"value\": \"\"}], \"arrayType\": \"int\"}, \"isHistory\": 0, \"isMonitor\": 0, \"isReadonly\": 0}], \"arrayType\": \"object\", \"arrayCount\": 5}', '0', '0', '0', '0', '0', '0', '0', 'admin', '2025-03-19 16:32:06', '', null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model` VALUES ('499', '功能分组', '55', '网关产品', '1', 'admin', 'group', '2', 'object', '{\"type\": \"object\", \"params\": [{\"id\": \"group_light\", \"name\": \"光照\", \"order\": 1, \"isChart\": 1, \"datatype\": {\"max\": 100, \"min\": 0, \"step\": 1, \"type\": \"decimal\", \"unit\": \"mm\"}, \"isHistory\": 1, \"isMonitor\": 1, \"isReadonly\": 1}, {\"id\": \"group_humidity\", \"name\": \"空气湿度\", \"order\": 2, \"isChart\": 1, \"datatype\": {\"max\": 100, \"min\": 0, \"step\": 0.1, \"type\": \"decimal\", \"unit\": \"%\"}, \"isMonitor\": 1, \"isReadonly\": 1}, {\"id\": \"group_temperature\", \"name\": \"空气温度-只读\", \"order\": 3, \"isChart\": 0, \"datatype\": {\"max\": 120, \"min\": -20, \"step\": 0.1, \"type\": \"decimal\", \"unit\": \"℃\"}, \"isMonitor\": 0, \"isReadonly\": 1}, {\"id\": \"group_report_monitor\", \"name\": \"上报监测数据\", \"order\": 7, \"datatype\": {\"max\": 10, \"min\": 1, \"step\": 1, \"type\": \"integer\", \"unit\": \"次数\"}, \"isHistory\": 0, \"isMonitor\": 0, \"isReadonly\": 0}, {\"id\": \"group_gear\", \"name\": \"运行档位\", \"order\": 5, \"datatype\": {\"type\": \"enum\", \"showWay\": \"select\", \"enumList\": [{\"text\": \"低速档位\", \"value\": \"0\"}, {\"text\": \"中速档位\", \"value\": \"1\"}, {\"text\": \"中高速档位\", \"value\": \"2\"}, {\"text\": \"高速档位\", \"value\": \"3\"}]}, \"isHistory\": 1, \"isMonitor\": 0, \"isReadonly\": 0}, {\"id\": \"group_switch\", \"name\": \"设备开关\", \"order\": 4, \"datatype\": {\"type\": \"bool\", \"trueText\": \"打开\", \"falseText\": \"关闭\"}, \"isMonitor\": 0, \"isReadonly\": 0}, {\"id\": \"group_irc\", \"name\": \"红外遥控\", \"order\": 6, \"isChart\": 0, \"datatype\": {\"type\": \"enum\", \"showWay\": \"button\", \"enumList\": [{\"text\": \"遥控学习\", \"value\": \"FFXX01\"}, {\"text\": \"遥控清码\", \"value\": \"FFXX02\"}, {\"text\": \"打开开关\", \"value\": \"FFXX03\"}, {\"text\": \"关闭开关\", \"value\": \"FFXX04\"}, {\"text\": \"暂停\", \"value\": \"FFXX05\"}, {\"text\": \"锁定\", \"value\": \"FFXX06\"}]}, \"isHistory\": 1, \"isMonitor\": 0, \"isReadonly\": 0}]}', '0', '0', '0', '0', '0', '0', '0', 'admin', '2025-03-19 16:32:06', '', null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model` VALUES ('500', '射频遥控', '55', '网关产品', '1', 'admin', 'irc', '2', 'enum', '{\"type\": \"enum\", \"showWay\": \"button\", \"enumList\": [{\"text\": \"遥控学习\", \"value\": \"FFXX01\"}, {\"text\": \"遥控清码\", \"value\": \"FFXX02\"}, {\"text\": \"打开开关\", \"value\": \"FFXX03\"}, {\"text\": \"关闭开关\", \"value\": \"FFXX04\"}, {\"text\": \"暂停\", \"value\": \"FFXX05\"}, {\"text\": \"锁定\", \"value\": \"FFXX06\"}]}', '0', '0', '1', '0', '0', '0', '0', 'admin', '2025-03-19 16:32:06', '', null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model` VALUES ('501', '上报状态', '55', '网关产品', '1', 'admin', 'status', '2', 'enum', '{\"type\": \"enum\", \"showWay\": \"button\", \"enumList\": [{\"text\": \"更新状态\", \"value\": \"update_status\"}]}', '0', '0', '0', '0', '1', '0', '0', 'admin', '2025-03-19 16:32:06', '', null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model` VALUES ('502', '运行档位', '55', '网关产品', '1', 'admin', 'gear', '2', 'enum', '{\"type\": \"enum\", \"showWay\": \"select\", \"enumList\": [{\"text\": \"低速档位\", \"value\": \"0\"}, {\"text\": \"中速档位\", \"value\": \"1\"}, {\"text\": \"中高速档位\", \"value\": \"2\"}, {\"text\": \"高速档位\", \"value\": \"3\"}]}', '0', '0', '1', '0', '0', '0', '0', 'admin', '2025-03-19 16:32:21', '', null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model` VALUES ('503', '灯光色值', '55', '网关产品', '1', 'admin', 'light_color', '2', 'array', '{\"type\": \"array\", \"arrayType\": \"integer\", \"arrayCount\": \"3\"}', '0', '0', '1', '0', '0', '0', '0', 'admin', '2025-03-19 16:32:21', '', null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model` VALUES ('504', '屏显消息', '55', '网关产品', '1', 'admin', 'message', '2', 'string', '{\"type\": \"string\", \"maxLength\": 1024}', '0', '0', '1', '0', '0', '0', '0', 'admin', '2025-03-19 16:32:21', '', null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model` VALUES ('505', '环境温度过高', '55', '网关产品', '1', 'admin', 'height_temperature', '3', 'decimal', '{\"max\": 100, \"min\": 0, \"step\": 0.1, \"type\": \"decimal\", \"unit\": \"℃\"}', '0', '0', '1', '0', '0', '0', '0', 'admin', '2025-03-19 16:32:21', '', null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model` VALUES ('506', '设备发生异常', '55', '网关产品', '1', 'admin', 'exception', '3', 'string', '{\"type\": \"string\", \"maxLength\": 1024}', '0', '0', '1', '0', '0', '0', '0', 'admin', '2025-03-19 16:32:21', '', null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model` VALUES ('507', '空气温度', '55', '网关产品', '1', 'admin', 'temperature', '1', 'decimal', '{\"max\": 120, \"min\": -20, \"step\": 0.1, \"type\": \"decimal\", \"unit\": \"℃\"}', '1', '1', '1', '1', '0', '0', '0', 'admin', '2025-03-19 16:32:31', '', null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model` VALUES ('508', '空气湿度', '55', '网关产品', '1', 'admin', 'humidity', '1', 'decimal', '{\"max\": 100, \"min\": 0, \"step\": 0.1, \"type\": \"decimal\", \"unit\": \"%\"}', '1', '1', '1', '1', '0', '0', '0', 'admin', '2025-03-19 16:32:31', '', null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model` VALUES ('509', '设备开关', '55', '网关产品', '1', 'admin', 'switch', '2', 'bool', '{\"type\": \"bool\", \"trueText\": \"打开\", \"falseText\": \"关闭\"}', '0', '0', '1', '0', '0', '0', '0', 'admin', '2025-03-19 16:32:31', '', null, null, null, null, null, null, null, null, null, null, null);
...
CREATE TABLE `iot_things_model_template` (
  ...
  `template_name` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL COMMENT '物模型名称',
  `tenant_id` bigint NOT NULL COMMENT '租户ID',
  `tenant_name` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '租户名称',
  `identifier` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL COMMENT '标识符，产品下唯一',
  `type` tinyint(1) NOT NULL COMMENT '模型类别（1-属性，2-功能，3-事件）',
  ...
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `remark` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '备注',
  `temp_slave_id` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '从机id',
  `formula` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '计算公式',
  `reverse_formula` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '控制公式',
  `reg_addr` int DEFAULT NULL COMMENT '寄存器地址值',
  `bit_option` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '位定义选项',
  `value_type` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '解析类型 1.数值 2.选项',
  `is_params` int(1) unsigned zerofill DEFAULT NULL COMMENT '是否是计算参数,默认否 0=否，1=是',
  `quantity` int DEFAULT NULL COMMENT '读取寄存器数量',
  `code` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'modbus功能码',
  `old_identifier` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '旧的标识符',
  `old_temp_slave_id` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '旧的从机id',
  `parse_type` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'modbus解析类型',
  PRIMARY KEY (`template_id`) USING BTREE,
  KEY `iot_things_model_template_index_tenant_id` (`tenant_id`) USING BTREE,
  KEY `iot_things_model_template_index_model_order` (`model_order`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=344 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='物模型模板';

-- ----------------------------
-- Records of iot_things_model_template
-- ----------------------------
INSERT INTO `iot_things_model_template` VALUES ('1', '空气温度', '1', 'admin', 'temperature', '1', 'decimal', '{\"max\": 120, \"min\": -20, \"step\": 0.1, \"type\": \"decimal\", \"unit\": \"℃\"}', '1', '1', '1', '1', '1', '0', '4', '0', 'admin', '2022-03-09 17:41:49', 'admin', '2023-04-10 01:12:06', null, null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model_template` VALUES ('2', '空气湿度', '1', 'admin', 'humidity', '1', 'decimal', '{\"max\": 100, \"min\": 0, \"step\": 0.1, \"type\": \"decimal\", \"unit\": \"%\"}', '1', '1', '1', '1', '1', '0', '3', '0', 'admin', '2022-03-09 17:41:49', 'admin', '2023-04-10 01:12:02', null, null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model_template` VALUES ('3', '二氧化碳', '1', 'admin', 'co2', '1', 'integer', '{\"max\": 6000, \"min\": 100, \"step\": 1, \"type\": \"integer\", \"unit\": \"ppm\"}', '1', '1', '1', '1', '1', '0', '0', '0', 'admin', '2022-03-09 17:41:49', 'admin', '2023-04-10 01:11:57', null, null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model_template` VALUES ('4', '室内亮度', '1', 'admin', 'brightness', '1', 'integer', '{\"max\": 10000, \"min\": 0, \"step\": 1, \"type\": \"integer\", \"unit\": \"cd/m2\"}', '1', '1', '1', '1', '1', '0', '0', '0', 'admin', '2022-03-09 17:41:49', 'admin', '2023-04-10 01:11:53', null, null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model_template` VALUES ('5', '设备开关', '1', 'admin', 'switch', '2', 'bool', '{\"type\": \"bool\", \"trueText\": \"打开\", \"falseText\": \"关闭\"}', '1', '0', '0', '1', '0', '0', '5', '0', 'admin', '2022-03-09 17:41:49', 'admin', '2023-04-10 01:11:48', null, null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model_template` VALUES ('6', '运行档位', '1', 'admin', 'gear', '2', 'enum', '{\"type\": \"enum\", \"showWay\": \"select\", \"enumList\": [{\"text\": \"低速档位\", \"value\": \"0\"}, {\"text\": \"中速档位\", \"value\": \"1\"}, {\"text\": \"中高速档位\", \"value\": \"2\"}, {\"text\": \"高速档位\", \"value\": \"3\"}]}', '1', '0', '0', '1', '0', '0', '6', '0', 'admin', '2022-03-09 17:41:49', 'admin', '2023-04-10 01:11:43', null, null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model_template` VALUES ('7', '灯光色值', '1', 'admin', 'light_color', '2', 'array', '{\"type\": \"array\", \"arrayType\": \"integer\", \"arrayCount\": \"3\"}', '1', '0', '0', '1', '0', '0', '2', '0', 'admin', '2022-03-09 17:41:49', 'admin', '2023-04-10 01:11:38', null, null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model_template` VALUES ('8', '屏显消息', '1', 'admin', 'message', '2', 'string', '{\"type\": \"string\", \"maxLength\": 1024}', '1', '0', '0', '1', '0', '0', '1', '0', 'admin', '2022-03-09 17:41:49', 'admin', '2023-04-10 01:11:32', null, null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model_template` VALUES ('9', '上报监测数据', '1', 'admin', 'report_monitor', '2', 'integer', '{\"max\": 10, \"min\": 1, \"step\": 1, \"type\": \"integer\", \"unit\": \"次数\"}', '1', '0', '0', '0', '0', '0', '9', '0', 'admin', '2022-03-09 17:41:49', 'admin', '2023-04-10 01:11:25', null, null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model_template` VALUES ('10', '环境温度过高', '1', 'admin', 'height_temperature', '3', 'decimal', '{\"max\": 100, \"min\": 0, \"step\": 0.1, \"type\": \"decimal\", \"unit\": \"℃\"}', '1', '0', '0', '1', '0', '0', '8', '0', 'admin', '2022-03-09 17:41:49', 'admin', '2023-04-10 01:11:19', null, null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model_template` VALUES ('11', '设备发生异常', '1', 'admin', 'exception', '3', 'string', '{\"type\": \"string\", \"maxLength\": 1024}', '1', '0', '0', '1', '0', '0', '7', '0', 'admin', '2022-03-09 17:41:49', 'admin', '2023-04-10 01:11:16', null, null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model_template` VALUES ('12', '光照', '1', 'admin', 'light', '1', 'decimal', '{\"max\": 100, \"min\": 0, \"step\": 1, \"type\": \"decimal\", \"unit\": \"mm\"}', '0', '1', '1', '1', '1', '0', '0', '0', 'wumei', '2022-05-07 09:41:17', 'admin', '2023-04-10 01:11:12', null, null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model_template` VALUES ('13', '压力', '1', 'admin', 'pressure', '1', 'decimal', '{\"max\": 200, \"min\": 0, \"step\": 0.1, \"type\": \"decimal\", \"unit\": \"帕斯卡\"}', '1', '1', '1', '1', '1', '0', '0', '0', 'admin', '2023-02-20 22:39:18', 'admin', '2023-04-10 01:11:05', null, null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model_template` VALUES ('14', '设备重启', '1', 'admin', 'reset', '2', 'enum', '{\"type\": \"enum\", \"showWay\": \"button\", \"enumList\": [{\"text\": \"重启\", \"value\": \"restart\"}]}', '1', '0', '0', '1', '0', '0', '0', '0', 'admin', '2023-02-20 23:15:25', 'admin', '2023-04-10 01:11:08', null, null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model_template` VALUES ('15', '电池电压', '1', 'admin', 'voltage', '1', 'decimal', '{\"max\": 5, \"min\": 0, \"step\": 0.001, \"type\": \"decimal\", \"unit\": \"V\"}', '1', '1', '1', '1', '1', '0', '0', '0', 'admin', '2023-02-20 23:17:43', 'admin', '2023-04-10 01:10:56', null, null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model_template` VALUES ('16', '饮水量', '1', 'admin', 'shuiliang', '1', 'integer', '{\"max\": 500, \"min\": 80, \"step\": 1, \"type\": \"integer\", \"unit\": \"ML\"}', '1', '1', '1', '1', '1', '0', '0', '0', 'admin', '2023-02-20 23:18:39', 'admin', '2023-04-10 01:10:52', null, null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model_template` VALUES ('17', '灯光', '1', 'admin', 'light', '1', 'integer', '{\"max\": 1000, \"min\": 0, \"step\": 1, \"type\": \"integer\", \"unit\": \"Lux\"}', '1', '1', '1', '1', '1', '0', '0', '0', 'admin', '2023-02-20 23:19:23', 'admin', '2023-04-10 01:10:49', null, null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model_template` VALUES ('18', '长度', '1', 'admin', 'length', '1', 'integer', '{\"max\": 2000, \"min\": 1, \"step\": 5, \"type\": \"integer\", \"unit\": \"M\"}', '1', '1', '1', '1', '1', '0', '0', '0', 'admin', '2023-02-20 23:20:03', 'admin', '2023-04-10 01:10:44', null, null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model_template` VALUES ('19', '心率', '1', 'admin', 'heart_rate', '1', 'integer', '{\"max\": 250, \"min\": 0, \"step\": 1, \"type\": \"integer\", \"unit\": \"次数\"}', '1', '1', '1', '1', '1', '0', '0', '0', 'admin', '2023-02-20 23:21:46', 'admin', '2023-04-10 01:12:40', null, null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model_template` VALUES ('20', '光照强度', '1', 'admin', 'light_level', '1', 'integer', '{\"max\": 89.2, \"min\": 2.5, \"step\": 0.1, \"type\": \"integer\", \"unit\": \"L/g\"}', '1', '1', '1', '1', '1', '0', '0', '0', 'admin', '2023-02-20 23:24:36', 'admin', '2023-04-10 01:10:35', null, null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model_template` VALUES ('21', '状态灯色', '1', 'admin', 'color', '2', 'enum', '{\"type\": \"enum\", \"showWay\": \"select\", \"enumList\": [{\"text\": \"红色\", \"value\": \"0\"}, {\"text\": \"绿色\", \"value\": \"1\"}, {\"text\": \"蓝色\", \"value\": \"2\"}, {\"text\": \"黄色\", \"value\": \"3\"}]}', '1', '0', '0', '1', '0', '0', '0', '0', 'admin', '2023-02-20 23:26:24', 'admin', '2023-04-10 01:10:32', null, null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model_template` VALUES ('22', '子设备', '1', 'admin', 'device', '2', 'array', '{\"type\": \"array\", \"params\": [{\"id\": \"device_co2\", \"name\": \"二氧化碳\", \"order\": 0, \"isChart\": 1, \"datatype\": {\"max\": 6000, \"min\": 100, \"step\": 1, \"type\": \"integer\", \"unit\": \"ppm\", \"enumList\": [{\"text\": \"\", \"value\": \"\"}], \"arrayType\": \"int\"}, \"isHistory\": 1, \"isMonitor\": 1, \"isReadonly\": 1}, {\"id\": \"device_temperature\", \"name\": \"空气温度-只读\", \"order\": 4, \"isChart\": 0, \"datatype\": {\"max\": 120, \"min\": -20, \"step\": 0.1, \"type\": \"decimal\", \"unit\": \"℃\", \"enumList\": [{\"text\": \"\", \"value\": \"\"}], \"arrayType\": \"int\"}, \"isMonitor\": 0, \"isReadonly\": 1}, {\"id\": \"device_gear\", \"name\": \"运行档位\", \"order\": 6, \"datatype\": {\"type\": \"enum\", \"showWay\": \"select\", \"enumList\": [{\"text\": \"低速档位\", \"value\": \"0\"}, {\"text\": \"中速档位\", \"value\": \"1\"}, {\"text\": \"中高速档位\", \"value\": \"2\"}, {\"text\": \"高速档位\", \"value\": \"3\"}]}, \"isMonitor\": 0, \"isReadonly\": 0}, {\"id\": \"device_switch\", \"name\": \"设备开关\", \"order\": 5, \"datatype\": {\"type\": \"bool\", \"enumList\": [{\"text\": \"\", \"value\": \"\"}], \"trueText\": \"打开\", \"arrayType\": \"int\", \"falseText\": \"关闭\"}, \"isMonitor\": 0, \"isReadonly\": 0}, {\"id\": \"device_report_monitor\", \"name\": \"上报监测数据\", \"order\": 9, \"datatype\": {\"max\": 10, \"min\": 1, \"step\": 1, \"type\": \"integer\", \"unit\": \"次数\", \"enumList\": [{\"text\": \"\", \"value\": \"\"}], \"arrayType\": \"int\"}, \"isHistory\": 0, \"isMonitor\": 0, \"isReadonly\": 0}], \"arrayType\": \"object\", \"arrayCount\": 5}', '1', '0', '0', '0', '0', '0', '10', '0', 'admin', '2023-02-24 01:10:43', 'admin', '2023-04-13 01:33:38', null, null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model_template` VALUES ('23', '功能分组', '1', 'admin', 'group', '2', 'object', '{\"type\": \"object\", \"params\": [{\"id\": \"group_light\", \"name\": \"光照\", \"order\": 1, \"isChart\": 1, \"datatype\": {\"max\": 100, \"min\": 0, \"step\": 1, \"type\": \"decimal\", \"unit\": \"mm\"}, \"isHistory\": 1, \"isMonitor\": 1, \"isReadonly\": 1}, {\"id\": \"group_humidity\", \"name\": \"空气湿度\", \"order\": 2, \"isChart\": 1, \"datatype\": {\"max\": 100, \"min\": 0, \"step\": 0.1, \"type\": \"decimal\", \"unit\": \"%\"}, \"isMonitor\": 1, \"isReadonly\": 1}, {\"id\": \"group_temperature\", \"name\": \"空气温度-只读\", \"order\": 3, \"isChart\": 0, \"datatype\": {\"max\": 120, \"min\": -20, \"step\": 0.1, \"type\": \"decimal\", \"unit\": \"℃\"}, \"isMonitor\": 0, \"isReadonly\": 1}, {\"id\": \"group_report_monitor\", \"name\": \"上报监测数据\", \"order\": 7, \"datatype\": {\"max\": 10, \"min\": 1, \"step\": 1, \"type\": \"integer\", \"unit\": \"次数\"}, \"isHistory\": 0, \"isMonitor\": 0, \"isReadonly\": 0}, {\"id\": \"group_gear\", \"name\": \"运行档位\", \"order\": 5, \"datatype\": {\"type\": \"enum\", \"showWay\": \"select\", \"enumList\": [{\"text\": \"低速档位\", \"value\": \"0\"}, {\"text\": \"中速档位\", \"value\": \"1\"}, {\"text\": \"中高速档位\", \"value\": \"2\"}, {\"text\": \"高速档位\", \"value\": \"3\"}]}, \"isHistory\": 1, \"isMonitor\": 0, \"isReadonly\": 0}, {\"id\": \"group_switch\", \"name\": \"设备开关\", \"order\": 4, \"datatype\": {\"type\": \"bool\", \"trueText\": \"打开\", \"falseText\": \"关闭\"}, \"isMonitor\": 0, \"isReadonly\": 0}, {\"id\": \"group_irc\", \"name\": \"红外遥控\", \"order\": 6, \"isChart\": 0, \"datatype\": {\"type\": \"enum\", \"showWay\": \"button\", \"enumList\": [{\"text\": \"遥控学习\", \"value\": \"FFXX01\"}, {\"text\": \"遥控清码\", \"value\": \"FFXX02\"}, {\"text\": \"打开开关\", \"value\": \"FFXX03\"}, {\"text\": \"关闭开关\", \"value\": \"FFXX04\"}, {\"text\": \"暂停\", \"value\": \"FFXX05\"}, {\"text\": \"锁定\", \"value\": \"FFXX06\"}]}, \"isHistory\": 1, \"isMonitor\": 0, \"isReadonly\": 0}]}', '1', '0', '0', '0', '0', '0', '11', '0', 'admin', '2023-02-25 22:41:43', 'admin', '2023-08-30 15:29:34', null, null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model_template` VALUES ('201', '频率 ', '1', 'admin', 'frequency', '2', 'integer', '{\"max\": 65535, \"min\": 0, \"step\": 1, \"type\": \"integer\", \"unit\": \"0.001Hz\"}', '1', '0', '0', '1', '0', '0', '0', '0', '', '2023-02-28 16:08:06', 'admin', '2023-04-10 03:37:11', null, '3#3', '%s*0.001', '', '27', '', null, null, null, null, null, null);
INSERT INTO `iot_things_model_template` VALUES ('225', '校验位', '1', 'admin', 'check', '2', 'enum', '{\"type\": \"enum\", \"showWay\": \"select\", \"enumList\": [{\"text\": \"N\", \"value\": \"0\"}, {\"text\": \"O\", \"value\": \"1\"}, {\"text\": \"E\", \"value\": \"2\"}]}', '1', '0', '0', '1', '1', '0', '0', '0', '', '2023-02-28 16:08:08', 'admin', '2023-04-10 21:36:01', null, '3#3', '', '', '771', '', null, null, null, null, null, null);
...
INSERT INTO `iot_things_model_template` VALUES ('227', '电压', '1', 'admin', 'voltage', '1', 'integer', '{\"max\": 6, \"min\": 0.1, \"step\": 0.1, \"type\": \"integer\", \"unit\": \"v\"}', '1', '1', '1', '1', '1', '0', '0', '0', '', '2023-02-28 16:08:09', 'admin', '2023-04-10 03:37:16', null, '3#3', '', '', '773', '', null, null, null, null, null, null);
INSERT INTO `iot_things_model_template` VALUES ('236', '射频遥控', '1', 'admin', 'irc', '2', 'enum', '{\"type\": \"enum\", \"showWay\": \"button\", \"enumList\": [{\"text\": \"遥控学习\", \"value\": \"FFXX01\"}, {\"text\": \"遥控清码\", \"value\": \"FFXX02\"}, {\"text\": \"打开开关\", \"value\": \"FFXX03\"}, {\"text\": \"关闭开关\", \"value\": \"FFXX04\"}, {\"text\": \"暂停\", \"value\": \"FFXX05\"}, {\"text\": \"锁定\", \"value\": \"FFXX06\"}]}', '1', '0', '0', '1', '0', '0', '0', '0', 'admin', '2023-03-31 23:46:20', 'admin', '2023-04-10 01:09:46', null, null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model_template` VALUES ('250', '漏水值', '1', 'admin', '0', '1', 'integer', '{\"max\": 100, \"min\": 1, \"step\": 1, \"type\": \"integer\", \"unit\": \"度\"}', '1', '0', '0', '1', '0', '0', '0', '0', '', '2023-04-11 22:35:36', '', '2023-09-13 23:32:34', null, '1#1', null, null, '0', null, null, null, '1', '3', null, null);
INSERT INTO `iot_things_model_template` VALUES ('251', '温度', '1', 'admin', '0', '1', 'integer', '{\"max\": 100, \"min\": 1, \"step\": 1, \"type\": \"integer\", \"unit\": \"°\"}', '1', '0', '0', '1', '0', '0', '0', '0', '', '2023-04-11 22:36:10', '', '2023-09-13 23:32:51', null, '1#2', null, null, '0', null, null, null, '1', '3', null, null);
INSERT INTO `iot_things_model_template` VALUES ('252', '电量', '1', 'admin', '1', '1', 'integer', '{\"max\": 100, \"min\": 1, \"step\": 1, \"type\": \"integer\", \"unit\": \"\"}', '1', '0', '0', '1', '0', '0', '0', '0', '', '2023-04-11 22:36:27', '', '2023-09-13 23:33:11', null, '1#11', null, null, '1', null, null, null, '1', '3', null, null);
INSERT INTO `iot_things_model_template` VALUES ('323', '上报状态', '1', 'admin', 'status', '2', 'enum', '{\"type\": \"enum\", \"showWay\": \"button\", \"enumList\": [{\"text\": \"更新状态\", \"value\": \"update_status\"}]}', '1', '0', '0', '0', '0', '1', '0', '0', 'admin', '2023-04-13 01:35:42', 'admin', '2023-09-03 10:50:16', null, null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model_template` VALUES ('324', 'X位移', '1', 'admin', 'x-shift', '1', 'decimal', '{\"max\": 100, \"min\": 0, \"step\": 1, \"type\": \"decimal\", \"unit\": \"mm\"}', '1', '1', '1', '1', '1', '0', '0', '0', '', '2023-08-26 19:36:58', '', null, null, '2#1', null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model_template` VALUES ('325', 'Y位移', '1', 'admin', 'y-shift', '1', 'decimal', '{\"max\": 100, \"min\": 0, \"step\": 1, \"type\": \"decimal\", \"unit\": \"mm\"}', '1', '1', '1', '1', '1', '0', '0', '0', '', '2023-08-26 19:37:23', '', '2023-08-26 19:37:32', null, '2#1', null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model_template` VALUES ('326', 'X位移', '1', 'admin', 'x-shift', '1', 'decimal', '{\"max\": 100, \"min\": 0, \"step\": 1, \"type\": \"decimal\", \"unit\": \"mm\"}', '1', '1', '1', '1', '1', '0', '0', '0', '', '2023-08-26 19:38:31', '', null, null, '2#2', null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model_template` VALUES ('327', 'Y位移', '1', 'admin', 'y-shift', '1', 'decimal', '{\"max\": 100, \"min\": 0, \"step\": 1, \"type\": \"decimal\", \"unit\": \"mm\"}', '1', '1', '1', '1', '1', '0', '0', '0', '', '2023-08-26 19:38:51', '', null, null, '2#2', null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model_template` VALUES ('328', '计件数量', '1', 'admin', '0', '1', 'integer', '{\"max\": 10000, \"min\": 0, \"step\": 1, \"type\": \"integer\", \"unit\": \"\"}', '1', '0', '0', '0', '1', '0', '0', '0', '', '2023-08-28 15:05:25', '', null, null, '3#1', null, null, '0', null, null, null, '1', '3', null, null);
INSERT INTO `iot_things_model_template` VALUES ('329', '参数1', '1', 'admin', '0', '1', 'integer', '{\"max\": 100, \"min\": 0, \"step\": 1, \"type\": \"integer\", \"unit\": \"\"}', '1', '0', '0', '0', '1', '0', '0', '0', '', '2023-08-28 15:06:55', '', null, null, '3#2', null, null, '0', null, null, null, '1', '3', null, null);
INSERT INTO `iot_things_model_template` VALUES ('330', '图片', '1', 'admin', 'image', '1', 'string', '{\"type\": \"string\", \"maxLength\": 10240}', '1', '0', '0', '1', '1', '0', '0', '0', '', '2023-08-28 23:19:30', '', null, null, '2#1', null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model_template` VALUES ('331', '回路状态', '10', 'jamon', 'loop_status', '1', 'array', '{\"type\": \"array\", \"arrayType\": \"integer\"}', '0', '0', '0', '0', '0', '0', '0', '0', '', '2023-08-29 18:21:38', '', null, null, '4#1', null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model_template` VALUES ('332', '回路状态', '10', 'jamon', 'loop_status', '1', 'array', '{\"type\": \"array\", \"arrayType\": \"integer\"}', '0', '0', '0', '0', '0', '0', '0', '0', '', '2023-08-29 18:23:08', '', null, null, '4#2', null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model_template` VALUES ('335', '湿度', '1', 'admin', '0', '1', 'integer', '{\"max\": 100, \"min\": 0, \"step\": 1, \"type\": \"integer\", \"unit\": \"\"}', '1', '0', '0', '1', '1', '0', '0', '0', '', '2023-08-30 14:05:38', '', '2023-08-30 14:58:28', null, '6#1', '%s/10', null, '0', null, null, null, '1', '3', null, null);
INSERT INTO `iot_things_model_template` VALUES ('336', '温度', '1', 'admin', '1', '1', 'integer', '{\"max\": 100, \"min\": 0, \"step\": 1, \"type\": \"integer\", \"unit\": \"°C\"}', '1', '0', '0', '1', '1', '0', '0', '0', '', '2023-08-30 14:06:05', '', '2023-08-30 14:58:38', null, '6#1', '%s/10', null, '1', null, null, null, '1', '3', null, null);
INSERT INTO `iot_things_model_template` VALUES ('341', '视频', '1', 'admin', 'video', '1', 'integer', '{\"max\": 100, \"min\": 0, \"step\": 1, \"type\": \"integer\", \"unit\": \"\"}', '1', '0', '0', '1', '1', '0', '0', '0', '', '2023-08-30 23:08:51', '', '2023-08-30 23:25:15', null, '2#1', null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model_template` VALUES ('342', '图片', '1', 'admin', 'image', '1', 'string', '{\"type\": \"string\", \"maxLength\": 1024}', '1', '0', '0', '1', '1', '0', '0', '0', '', '2023-08-30 23:21:48', '', '2023-08-30 23:25:22', null, '2#2', null, null, null, null, null, null, null, null, null, null);
INSERT INTO `iot_things_model_template` VALUES ('343', '状态', '1', 'admin', 'status', '1', 'integer', '{\"max\": 100, \"min\": 0, \"step\": 1, \"type\": \"integer\", \"unit\": \"\"}', '1', '0', '0', '1', '1', '0', '0', '0', '', '2023-08-30 23:28:00', '', '2023-08-30 23:28:17', null, '2#1', null, null, null, null, null, null, null, null, null, null);
...
CREATE TABLE `media_server` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '流媒体配置ID',
  `server_id` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '服务器标识',
  `tenant_id` bigint NOT NULL COMMENT '租户ID',
  `tenant_name` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '租户名称',
  `enabled` tinyint(1) DEFAULT NULL COMMENT '使能开关',
  `protocol` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '默认播放协议',
  `ip` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '服务器ip',
  `domain` varchar(128) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '服务器域名',
  `hookurl` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '回调服务器地址',
  `secret` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '流媒体密钥',
  `port_http` int NOT NULL DEFAULT '0' COMMENT 'http端口',
  `port_https` int NOT NULL DEFAULT '0' COMMENT 'https端口',
  `port_rtmp` int NOT NULL DEFAULT '0' COMMENT 'rtmp端口',
  `port_rtsp` int NOT NULL DEFAULT '0' COMMENT 'rtsp端口',
  `rtp_proxy_port` int NOT NULL DEFAULT '0' COMMENT 'RTP收流端口',
  `rtp_enable` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否使用多端口模式',
  `rtp_port_range` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT 'rtp端口范围',
  `record_port` int NOT NULL DEFAULT '0' COMMENT '录像服务端口',
  ...
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `remark` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '备注',
  `port_ws` int DEFAULT NULL COMMENT 'ws端口',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='流媒体服务器配置';

-- ----------------------------
-- Records of media_server
-- ----------------------------
INSERT INTO `media_server` VALUES ('7', 'gyjiot', '1', 'admin', '1', 'http', '192.168.2.120', 'gyjiot.com2', '192.168.2.15:8080', '035c73f7-bb6b-4889-a715-d9eb2d192xxx', '8082', '8443', '1935', '554', '0', '1', '30000,30103', '18081', '1', '0', '0', '', '2023-09-26 21:11:43', '', '2023-10-26 21:51:25', null, null);
...
CREATE TABLE `news` (
  ...
  `title` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL COMMENT '标题',
  `content` text CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL COMMENT '内容',
  `img_url` varchar(128) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL COMMENT '封面',
  ...
  `category_name` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL COMMENT '分类名称',
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '新闻状态（0-未发布，1-已发布）',
  `author` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL COMMENT '作者',
  ...
  KEY `news_index_category_id` (`category_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='新闻资讯';
...
CREATE TABLE `news_category` (
  ...
  `category_name` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL COMMENT '分类名称',
  ...
  `remark` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`category_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='新闻分类';
...
CREATE TABLE `oauth_client_details` (
  ...
  `resource_ids` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '客户端所能访问的资源id集合,多个资源时用逗号(,)分隔',
  `client_secret` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '客户端秘钥',
  `scope` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '权限范围,可选值包括read,write,trust;若有多个权限范围用逗号(,)分隔',
  `authorized_grant_types` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '授权模式，可选值包括authorization_code,password,refresh_token,implicit,client_credentials, 若支持多个grant_type用逗号(,)分隔',
  `web_server_redirect_uri` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '回调地址',
  `authorities` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '权限',
  ...
  `additional_information` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '预留的字段,在Oauth的流程中没有实际的使用,可选,但若设置值,必须是JSON格式的数据',
  `autoapprove` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '设置用户是否自动Approval操作, 默认值为 ''false'', 可选值包括 ''true'',''false'', ''read'',''write''. \n该字段只适用于grant_type="authorization_code"的情况,当用户登录成功后,若该值为''true''或支持的scope值,则会跳过用户Approve的页面, 直接授权. ',
  `type` tinyint(1) DEFAULT NULL COMMENT '1=小度(DuerOS),2=天猫精灵(ALiGenie),3=小米小爱',
...
INSERT INTO `oauth_client_details` VALUES ('gyjiot-dueros', 'speaker-service', 'S2EneHxdt^MHhBv8N#$^ty6nq$NQY2Nc', 'read,write', 'authorization_code,refresh_token', 'https://xiaodu.baidu.com/saiya/auth/35dc8a5b53719ea6bbb7bd818ca8d5b6', 'ROLE_ADMIN', '7200', '7200', null, 'false', '1');
...
-- ----------------------------
INSERT INTO `qrtz_job_details` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME1', 'DEFAULT', null, 'com.gyjiot.quartz.util.QuartzDisallowConcurrentExecution', '0', '1', '0', '0', );
INSERT INTO `qrtz_job_details` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME2', 'DEFAULT', null, 'com.gyjiot.quartz.util.QuartzDisallowConcurrentExecution', '0', '1', '0', '0', );
INSERT INTO `qrtz_job_details` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME3', 'DEFAULT', null, 'com.gyjiot.quartz.util.QuartzDisallowConcurrentExecution', '0', '1', '0', '0', );
INSERT INTO `qrtz_job_details` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME4', 'SYSTEM', null, 'com.gyjiot.quartz.util.QuartzJobExecution', '0', '0', '0', '0', );
INSERT INTO `qrtz_job_details` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME5', 'SYSTEM', null, 'com.gyjiot.quartz.util.QuartzDisallowConcurrentExecution', '0', '1', '0', '0', );
...
CREATE TABLE `sip_config` (
  ...
  `product_id` bigint NOT NULL COMMENT '产品ID',
  `product_name` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '产品名称',
  `enabled` tinyint(1) DEFAULT NULL COMMENT '使能开关',
  `isdefault` tinyint(1) DEFAULT NULL COMMENT '系统默认配置',
  `seniorSdp` tinyint(1) DEFAULT NULL COMMENT '拓展sdp',
  `domain_alias` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '服务器域',
  `server_sipid` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '服务器sipid',
  `password` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT 'sip认证密码',
  `ip` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'sip接入IP',
  `port` bigint DEFAULT NULL COMMENT 'sip接入端口号',
  `del_flag` char(1) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '删除标志（0代表存在 2代表删除）',
  `create_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT '' COMMENT '更新者',
  ...
  `remark` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='sip系统配置';
...
CREATE TABLE `sip_device` (
  ...
  `product_name` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '产品名称',
  `device_sip_id` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL COMMENT '设备SipID',
  `device_name` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '设备名称',
  `manufacturer` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '厂商名称',
  `model` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '产品型号',
  `firmware` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '固件版本',
  `transport` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT 'UDP' COMMENT '传输模式',
  `stream_mode` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT 'UDP' COMMENT '流模式',
  `online` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '在线状态',
  `register_time` datetime NOT NULL COMMENT '注册时间',
  `last_connect_time` datetime DEFAULT NULL COMMENT '最后上线时间',
  `active_time` datetime DEFAULT NULL COMMENT '激活时间',
  `ip` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '设备入网IP',
  `port` bigint DEFAULT NULL COMMENT '设备接入端口号',
  `host_address` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '设备地址',
  `del_flag` char(1) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT '0' COMMENT '删除标志（0代表存在 2代表删除）',
  `create_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT '' COMMENT '创建者',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT '' COMMENT '更新者',
...
CREATE TABLE `sip_device_channel` (
  ...
  `product_id` bigint NOT NULL DEFAULT '0' COMMENT '产品ID',
  `product_name` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '产品名称',
  `user_id` bigint NOT NULL DEFAULT '0' COMMENT '产品ID',
  `user_name` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '产品名称',
  `device_sip_id` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL COMMENT '设备SipID',
  `channel_sip_id` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL COMMENT '通道SipID',
  `channel_name` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '通道名称',
  `register_time` datetime DEFAULT NULL COMMENT '注册时间',
  `device_type` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT '' COMMENT '设备类型',
  `channel_type` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT '' COMMENT '通道类型',
  `cityCode` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '城市编码',
  `civilCode` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '行政区域',
  `manufacture` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '厂商名称',
  `model` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '产品型号',
  `owner` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '设备归属',
  `block` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '警区',
  `address` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '安装地址',
  `parentId` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '父级id',
  `ipAddress` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '设备入网IP',
  `port` bigint DEFAULT '0' COMMENT '设备接入端口号',
  `password` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '密码',
  `PTZType` bigint NOT NULL DEFAULT '0' COMMENT 'PTZ类型',
  `PTZTypeText` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT 'PTZ类型描述字符串',
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '设备状态（1-未激活，2-禁用，3-在线，4-离线）',
  `longitude` double(11,6) DEFAULT NULL COMMENT '设备经度',
  `latitude` double(11,6) DEFAULT NULL COMMENT '设备纬度',
  `streamId` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '流媒体ID',
  `subCount` bigint NOT NULL DEFAULT '0' COMMENT '子设备数',
...
) ENGINE=InnoDB AUTO_INCREMENT=103 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='监控设备通道信息';
...
CREATE TABLE `sys_auth_user` (
  ...
  `source` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '用户来源',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`auth_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='第三方授权表';
...
-- Records of sys_dept
-- ----------------------------
INSERT INTO `sys_dept` VALUES ('100', '0', '0', '管伊佳物联', '0', 'Gyjiot', '15888888888', '752718920@qq.com', '0', '0', 'admin', '2021-12-15 21:36:18', 'admin', '2023-02-26 23:06:24');
INSERT INTO `sys_dept` VALUES ('101', '100', '0,100', '北京总公司', '1', '物美', '15888888888', '752718920@qq.com', '0', '0', 'admin', '2021-12-15 21:36:18', 'admin', '2022-03-09 16:49:53');
INSERT INTO `sys_dept` VALUES ('102', '100', '0,100', '深圳分公司', '2', '物美', '15888888888', '752718920@qq.com', '0', '0', 'admin', '2021-12-15 21:36:18', 'admin', '2023-02-26 23:06:07');
INSERT INTO `sys_dept` VALUES ('103', '101', '0,100,101', '研发部门', '1', '物美', '15888888888', '752718920@qq.com', '1', '0', 'admin', '2021-12-15 21:36:18', 'admin', '2022-02-01 23:12:40');
INSERT INTO `sys_dept` VALUES ('104', '101', '0,100,101', '市场部门', '2', '物美', '15888888888', '752718920@qq.com', '0', '0', 'admin', '2021-12-15 21:36:18', '', null);
INSERT INTO `sys_dept` VALUES ('105', '101', '0,100,101', '测试部门', '3', '物美', '15888888888', '752718920@qq.com', '0', '0', 'admin', '2021-12-15 21:36:18', '', null);
INSERT INTO `sys_dept` VALUES ('106', '101', '0,100,101', '财务部门', '4', '物美', '15888888888', '752718920@qq.com', '0', '0', 'admin', '2021-12-15 21:36:18', '', null);
INSERT INTO `sys_dept` VALUES ('107', '101', '0,100,101', '运维部门', '5', '物美', '15888888888', '752718920@qq.com', '0', '0', 'admin', '2021-12-15 21:36:18', '', null);
INSERT INTO `sys_dept` VALUES ('108', '102', '0,100,102', '市场部门', '1', '物美', '15888888888', '752718920@qq.com', '0', '0', 'admin', '2021-12-15 21:36:18', '', null);
INSERT INTO `sys_dept` VALUES ('109', '102', '0,100,102', '财务部门', '2', '物美', '15888888888', '752718920@qq.com', '0', '0', 'admin', '2021-12-15 21:36:18', '', null);
...
INSERT INTO `sys_dict_data` VALUES ('198', '0', 'MQTT', 'MQTT', 'iot_transport_type', null, 'primary', 'N', '0', 'admin', '2023-02-28 16:35:40', 'admin', '2025-03-19 16:23:48', null);
...
INSERT INTO `sys_dict_data` VALUES ('241', '4', 'GB28181', 'GB28181', 'iot_transport_type', null, 'success', 'N', '0', 'admin', '2023-05-12 14:25:39', 'admin', '2025-03-19 16:24:12', null);
...
CREATE TABLE `sys_job` (
  ...
  `remark` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '备注信息',
  PRIMARY KEY (`job_id`,`job_name`,`job_group`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='定时任务调度表';
...
-- ----------------------------
INSERT INTO `sys_notice` VALUES ('1', '管伊佳V1.0版本发布', '2', , '0', 'admin', '2021-12-15 21:36:18', 'admin', '2023-09-26 21:21:30', '管理员');
INSERT INTO `sys_notice` VALUES ('2', 'Gyjiot sdk支持树莓派', '1', , '0', 'admin', '2021-12-15 21:36:18', 'admin', '2023-09-26 21:21:41', '管理员');
...
INSERT INTO `sys_role` VALUES ('4', '游客', 'visitor', '4', '1', '1', '1', '0', '0', 'admin', '2021-12-16 16:44:30', 'admin', '2025-03-19 15:06:10', '只能查询和新增系统数据');
INSERT INTO `sys_role` VALUES ('5', '管理员', 'manager', '5', '1', '1', '1', '0', '0', 'admin', '2022-06-10 13:54:29', 'admin', '2025-03-19 15:10:17', '普通管理员');
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='用户信息表';
...
INSERT INTO `sys_user` VALUES ('5', '100', 'gyjiot-u2', '管伊佳用户贰', '00', '', '15888888883', '0', '', '$2a$10$x3rM39rewwbi7ayvriGMEOKUHoPCqcL2CYXPLTJRCWYPVvykFIYJq', '0', '0', '127.0.0.1', '2022-06-12 00:55:45', 'admin', '2022-04-15 16:23:13', 'admin', '2022-06-12 00:55:46', null);
INSERT INTO `sys_user` VALUES ('6', '100', 'gyjiot', '游客账号', '00', '', '15888888884', '0', '', '$2a$10$kKeZptrTnSlm0fencX4U2eq.QiaukDs.DckiUsMCwVTxh0IS2LRQ.', '0', '0', '127.0.0.1', '2023-09-21 18:39:29', 'admin', '2022-03-09 16:49:19', 'admin', '2023-09-21 18:39:28', null);
...
INSERT INTO `sys_user` VALUES ('8', null, 'shadow', 'shadow', '00', '', '15752221201', '0', '', '$2a$10$FXSw4fufDjecEhMxYjji3.7PkrpwkliCBoQO.h8nW0Nhk0bPpxS6u', '0', '2', '39.130.41.108', '2023-09-15 17:21:33', '', '2023-08-23 11:34:23', '', '2023-09-15 17:21:32', null);
...
INSERT INTO `sys_user` VALUES ('11', '101', 'gyjiot123', 'gyjiot123', '00', '', '18231210622', '0', '', '$2a$10$qpLuw5yAIDLV/.UCIaWRROxhtI2nYpJe/.tbIKwSmy2Pxm.vc26Ri', '0', '2', '27.187.242.251', '2023-08-31 16:22:40', 'admin', '2023-08-31 16:22:21', '', '2023-08-31 16:22:40', null);
