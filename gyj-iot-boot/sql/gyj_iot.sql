/*
 ...
 Source Schema         : gyj_iot

 Target Server Type    : MySQL
 Target Server Version : 80029
 File Encoding         : 65001

 Date: 10/02/2026 15:16:30
*/
...
CREATE TABLE `iot_category`  (
  `category_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '产品分类ID',
...
CREATE TABLE `iot_device`  (
  ...
  `rssi` tinyint(0) NULL DEFAULT NULL COMMENT '信号强度（\r\n信号极好4格[-55— 0]，\r\n信号好3格[-70— -55]，\r\n信号一般2格[-85— -70]，\r\n信号差1格[-100— -85]）',
  ...
  `slave_id` int(0) NULL DEFAULT NULL COMMENT '从机id',
  `is_sys` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否系统通用（0-否，1-是）',
...
CREATE TABLE `iot_device_job`  (
  ...
  `scene_id` bigint(0) NULL DEFAULT NULL COMMENT '场景联动ID',
  `alert_id` bigint(0) NULL DEFAULT NULL COMMENT '告警ID',
...
CREATE TABLE `iot_device_log`  (
  `log_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '设备监测信息ID',
...
CREATE TABLE `iot_device_template`  (
  ...
  `product_id` bigint(0) NULL DEFAULT NULL COMMENT '产品id',
  `template_id` bigint(0) NULL DEFAULT NULL COMMENT '采集点模板id',
...
CREATE TABLE `iot_device_user`  (
  ...
  `user_name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '用户昵称',
  `is_owner` tinyint(0) NOT NULL COMMENT '是否为设备所有者（0=否，1=是）',
...
CREATE TABLE `iot_event_log`  (
  `log_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '设备事件日志ID',
  `identify` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '标识符',
  `model_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '物模型名称',
...
CREATE TABLE `iot_function_log`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '设备功能日志ID',
  `identify` varchar(64) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '标识符',
  `fun_type` int(0) NOT NULL COMMENT '1==服务下发，2=属性获取，3.OTA升级',
  ...
  `mode` int(0) NULL DEFAULT NULL COMMENT '模式(1=影子模式，2=在线模式，3=其他)',
  `user_id` bigint(0) NULL DEFAULT NULL COMMENT '用户id',
  `result_msg` varchar(128) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '下发结果描述',
  `result_code` int(0) NULL DEFAULT NULL COMMENT '下发结果代码',
...
CREATE TABLE `iot_group`  (
  `group_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '分组ID',
  `group_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '分组名称',
  `group_order` tinyint(0) NOT NULL DEFAULT 0 COMMENT '分组排序',
  `user_id` bigint(0) NOT NULL COMMENT '用户ID',
  `user_name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '用户昵称',
  `del_flag` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0' COMMENT '删除标志（0代表存在 2代表删除）',
  `create_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '创建者',
...
CREATE TABLE `iot_product`  (
  ...
  `category_id` bigint(0) NOT NULL COMMENT '产品分类ID',
  `category_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '产品分类名称',
  `tenant_id` bigint(0) NOT NULL COMMENT '租户ID',
  `tenant_name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '租户名称',
  `is_sys` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否系统通用（0-否，1-是）',
...
) ENGINE = InnoDB AUTO_INCREMENT = 89 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '产品' ROW_FORMAT = Dynamic;
...
INSERT INTO `iot_product` VALUES (88, '视频监控产品', NULL, 2, '家居安防', 1, 'admin', 1, 0, 'Gyjiot', 'P0IB9M8A7J4R056V', 'K69914VL8175ZY21', 2, '{}', 3, 1, 3, NULL, '0', '', '2023-04-11 21:11:54', '', '2025-03-19 15:30:14', NULL, 'GB28181');
...
CREATE TABLE `iot_product_authorize`  (
  `authorize_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '授权码ID',
...
CREATE TABLE `iot_protocol`  (
  ...
  `protocol_type` int(0) NOT NULL DEFAULT 0 COMMENT '协议类型 0:未知 1:jar，2.js,3.c',
  ...
  `protocol_status` int(0) NOT NULL DEFAULT 0 COMMENT '0:草稿 1:启用 2:停用',
  `del_flag` int(0) NOT NULL DEFAULT 0 COMMENT '0:正常 1:删除',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `UNIQUE_CODE`(`protocol_code`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '协议表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `iot_scene`  (
  `scene_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '场景ID',
  ...
  `silent_period` int(0) NULL DEFAULT NULL COMMENT '静默周期（分钟）',
  `cond` tinyint(0) NULL DEFAULT NULL COMMENT '执行条件（1=或、任意条件，2=且、所有条件，3=非，不满足）',
  `execute_mode` tinyint(1) NULL DEFAULT NULL COMMENT '执行方式（1=串行，顺序执行，2=并行，同时执行）',
  `execute_delay` int(0) NULL DEFAULT NULL COMMENT '延时执行（秒钟）',
...
CREATE TABLE `iot_scene_script`  (
  ...
  `product_id` bigint(0) NULL DEFAULT NULL COMMENT '产品ID（用于获取对应物模型）',
  `product_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '产品名称',
  ...
  `device_count` int(0) NULL DEFAULT NULL COMMENT '设备数量',
...
CREATE TABLE `iot_script`  (
  ...
  `user_id` bigint(0) NOT NULL COMMENT '用户ID',
  `user_name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '用户昵称',
  `scene_id` bigint(0) NOT NULL DEFAULT 0 COMMENT '关联场景ID',
  `product_id` bigint(0) NULL DEFAULT NULL COMMENT '产品ID',
  `product_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '产品名称',
...
CREATE TABLE `iot_social_platform`  (
  `social_platform_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '第三方登录平台主键',
...
CREATE TABLE `iot_social_user`  (
  `social_user_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '第三方系统用户表主键',
  ...
  `expire_in` int(0) NULL DEFAULT NULL COMMENT '第三方用户的授权令牌的有效期（部分平台可能没有）',
  ...
  `gender` tinyint(0) NULL DEFAULT NULL COMMENT '用户性别',
...
CREATE TABLE `iot_things_model`  (
  `model_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '物模型ID',
  ...
  `model_order` int(0) NULL DEFAULT 0 COMMENT '排序，值越大，排序越靠前',
  `del_flag` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0' COMMENT '删除标志（0代表存在 2代表删除）',
  `create_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '更新者',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  `remark` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  `temp_slave_id` bigint(0) NULL DEFAULT NULL COMMENT '从机id',
  ...
  `reg_addr` int(0) NULL DEFAULT NULL COMMENT '寄存器地址值',
  ...
  `is_params` int(0) NULL DEFAULT NULL COMMENT '是否是计算参数',
  `quantity` int(0) NULL DEFAULT NULL COMMENT '读取寄存器数量',
...
) ENGINE = InnoDB AUTO_INCREMENT = 510 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '物模型' ROW_FORMAT = Dynamic;
...
INSERT INTO `iot_things_model` VALUES (496, '光照强度', 55, '网关产品', 1, 'admin', 'light_level', 1, 'integer', '{\"max\": 89.2, \"min\": 2.5, \"step\": 0.1, \"type\": \"integer\", \"unit\": \"L/g\"}', 1, 1, 1, 1, 0, 0, '0', 'admin', '2025-03-19 16:32:06', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iot_things_model` VALUES (497, '状态灯色', 55, '网关产品', 1, 'admin', 'color', 2, 'enum', '{\"type\": \"enum\", \"showWay\": \"select\", \"enumList\": [{\"text\": \"红色\", \"value\": \"0\"}, {\"text\": \"绿色\", \"value\": \"1\"}, {\"text\": \"蓝色\", \"value\": \"2\"}, {\"text\": \"黄色\", \"value\": \"3\"}]}', 0, 0, 1, 0, 0, 0, '0', 'admin', '2025-03-19 16:32:06', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `iot_things_model` VALUES (501, '上报状态', 55, '网关产品', 1, 'admin', 'status', 2, 'enum', '{\"type\": \"enum\", \"showWay\": \"button\", \"enumList\": [{\"text\": \"更新状态\", \"value\": \"update_status\"}]}', 0, 0, 0, 0, 1, 0, '0', 'admin', '2025-03-19 16:32:06', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iot_things_model` VALUES (502, '运行档位', 55, '网关产品', 1, 'admin', 'gear', 2, 'enum', '{\"type\": \"enum\", \"showWay\": \"select\", \"enumList\": [{\"text\": \"低速档位\", \"value\": \"0\"}, {\"text\": \"中速档位\", \"value\": \"1\"}, {\"text\": \"中高速档位\", \"value\": \"2\"}, {\"text\": \"高速档位\", \"value\": \"3\"}]}', 0, 0, 1, 0, 0, 0, '0', 'admin', '2025-03-19 16:32:21', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iot_things_model` VALUES (503, '灯光色值', 55, '网关产品', 1, 'admin', 'light_color', 2, 'array', '{\"type\": \"array\", \"arrayType\": \"integer\", \"arrayCount\": \"3\"}', 0, 0, 1, 0, 0, 0, '0', 'admin', '2025-03-19 16:32:21', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iot_things_model` VALUES (504, '屏显消息', 55, '网关产品', 1, 'admin', 'message', 2, 'string', '{\"type\": \"string\", \"maxLength\": 1024}', 0, 0, 1, 0, 0, 0, '0', 'admin', '2025-03-19 16:32:21', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iot_things_model` VALUES (505, '环境温度过高', 55, '网关产品', 1, 'admin', 'height_temperature', 3, 'decimal', '{\"max\": 100, \"min\": 0, \"step\": 0.1, \"type\": \"decimal\", \"unit\": \"℃\"}', 0, 0, 1, 0, 0, 0, '0', 'admin', '2025-03-19 16:32:21', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iot_things_model` VALUES (506, '设备发生异常', 55, '网关产品', 1, 'admin', 'exception', 3, 'string', '{\"type\": \"string\", \"maxLength\": 1024}', 0, 0, 1, 0, 0, 0, '0', 'admin', '2025-03-19 16:32:21', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iot_things_model` VALUES (507, '空气温度', 55, '网关产品', 1, 'admin', 'temperature', 1, 'decimal', '{\"max\": 120, \"min\": -20, \"step\": 0.1, \"type\": \"decimal\", \"unit\": \"℃\"}', 1, 1, 1, 1, 0, 0, '0', 'admin', '2025-03-19 16:32:31', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iot_things_model` VALUES (508, '空气湿度', 55, '网关产品', 1, 'admin', 'humidity', 1, 'decimal', '{\"max\": 100, \"min\": 0, \"step\": 0.1, \"type\": \"decimal\", \"unit\": \"%\"}', 1, 1, 1, 1, 0, 0, '0', 'admin', '2025-03-19 16:32:31', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iot_things_model` VALUES (509, '设备开关', 55, '网关产品', 1, 'admin', 'switch', 2, 'bool', '{\"type\": \"bool\", \"trueText\": \"打开\", \"falseText\": \"关闭\"}', 0, 0, 1, 0, 0, 0, '0', 'admin', '2025-03-19 16:32:31', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `iot_things_model_template`  (
  `template_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '物模型ID',
...
CREATE TABLE `media_server`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '流媒体配置ID',
  ...
  `port_http` int(0) NOT NULL DEFAULT 0 COMMENT 'http端口',
  `port_https` int(0) NOT NULL DEFAULT 0 COMMENT 'https端口',
  `port_rtmp` int(0) NOT NULL DEFAULT 0 COMMENT 'rtmp端口',
  `port_rtsp` int(0) NOT NULL DEFAULT 0 COMMENT 'rtsp端口',
  `rtp_proxy_port` int(0) NOT NULL DEFAULT 0 COMMENT 'RTP收流端口',
  ...
  `record_port` int(0) NOT NULL DEFAULT 0 COMMENT '录像服务端口',
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  `remark` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  `port_ws` int(0) NULL DEFAULT NULL COMMENT 'ws端口',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `news`  (
  `news_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '新闻ID',
...
CREATE TABLE `oauth_client_details`  (
  ...
  `access_token_validity` int(0) NULL DEFAULT NULL COMMENT '设定客户端的access_token的有效时间值(单位:秒)',
  `refresh_token_validity` int(0) NULL DEFAULT NULL COMMENT '设定客户端的refresh_token的有效时间值(单位:秒)',
...
CREATE TABLE `sip_config`  (
  ...
  `port` bigint(0) NULL DEFAULT NULL COMMENT 'sip接入端口号',
  `del_flag` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '删除标志（0代表存在 2代表删除）',
  `create_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '更新者',
  ...
  `remark` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 43 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'sip系统配置' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sip_device`  (
  `device_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '设备ID',
  `product_id` bigint(0) NOT NULL DEFAULT 0 COMMENT '产品ID',
  `product_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '产品名称',
  ...
  `last_connect_time` datetime(0) NULL DEFAULT NULL COMMENT '最后上线时间',
  `active_time` datetime(0) NULL DEFAULT NULL COMMENT '激活时间',
  `ip` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '设备入网IP',
  `port` bigint(0) NULL DEFAULT NULL COMMENT '设备接入端口号',
  ...
  `remark` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`device_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 21 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '监控设备' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sip_device_channel`  (
  ...
  `product_id` bigint(0) NOT NULL DEFAULT 0 COMMENT '产品ID',
  `product_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '产品名称',
  `user_id` bigint(0) NOT NULL DEFAULT 0 COMMENT '产品ID',
  ...
  `port` bigint(0) NULL DEFAULT 0 COMMENT '设备接入端口号',
  `password` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '密码',
  `PTZType` bigint(0) NOT NULL DEFAULT 0 COMMENT 'PTZ类型',
  ...
  `subCount` bigint(0) NOT NULL DEFAULT 0 COMMENT '子设备数',
...
CREATE TABLE `sys_auth_user`  (
  `auth_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '授权ID',
...
INSERT INTO `sys_dict_data` VALUES (172, 4, '模拟摄像机', '131', 'video_type', NULL, 'default', 'N', '0', 'admin', '2023-02-22 01:08:52', '', NULL, NULL);
INSERT INTO `sys_dict_data` VALUES (173, 5, '网络摄像机IPC', '132', 'video_type', NULL, 'default', 'N', '0', 'admin', '2023-02-22 01:09:11', '', NULL, NULL);
...
INSERT INTO `sys_dict_data` VALUES (181, 1, '模拟摄像机', '131', 'channel_type', NULL, 'default', 'N', '0', 'admin', '2023-02-22 01:12:24', '', NULL, NULL);
INSERT INTO `sys_dict_data` VALUES (182, 2, '网络摄像机IPC', '132', 'channel_type', NULL, 'default', 'N', '0', 'admin', '2023-02-22 01:12:39', '', NULL, NULL);
...
INSERT INTO `sys_job_log` VALUES (3, '设备定时同步', 'SYSTEM', 'deviceJob.syncDeviceStatus', '设备定时同步 总共耗时：8毫秒', '0', '', '2025-09-26 15:01:00');
INSERT INTO `sys_job_log` VALUES (4, '设备定时同步', 'SYSTEM', 'deviceJob.syncDeviceStatus', '设备定时同步 总共耗时：2毫秒', '0', '', '2025-09-26 15:02:00');
INSERT INTO `sys_job_log` VALUES (5, '监控在线状态更新', 'SYSTEM', 'deviceJob.updateSipDeviceOnlineStatus(90)', '监控在线状态更新 总共耗时：37毫秒', '0', '', '2025-09-26 15:02:00');
INSERT INTO `sys_job_log` VALUES (6, '设备定时同步', 'SYSTEM', 'deviceJob.syncDeviceStatus', '设备定时同步 总共耗时：2毫秒', '0', '', '2025-09-26 15:03:00');
INSERT INTO `sys_job_log` VALUES (7, '设备定时同步', 'SYSTEM', 'deviceJob.syncDeviceStatus', '设备定时同步 总共耗时：2毫秒', '0', '', '2025-09-26 15:05:00');
INSERT INTO `sys_job_log` VALUES (8, '设备定时同步', 'SYSTEM', 'deviceJob.syncDeviceStatus', '设备定时同步 总共耗时：2毫秒', '0', '', '2025-09-26 15:06:00');
INSERT INTO `sys_job_log` VALUES (9, '监控在线状态更新', 'SYSTEM', 'deviceJob.updateSipDeviceOnlineStatus(90)', '监控在线状态更新 总共耗时：39毫秒', '0', '', '2025-09-26 15:06:00');
INSERT INTO `sys_job_log` VALUES (10, '设备定时同步', 'SYSTEM', 'deviceJob.syncDeviceStatus', '设备定时同步 总共耗时：2毫秒', '0', '', '2025-09-26 15:07:00');
INSERT INTO `sys_job_log` VALUES (11, '设备定时同步', 'SYSTEM', 'deviceJob.syncDeviceStatus', '设备定时同步 总共耗时：2毫秒', '0', '', '2025-09-26 15:08:00');
INSERT INTO `sys_job_log` VALUES (12, '监控在线状态更新', 'SYSTEM', 'deviceJob.updateSipDeviceOnlineStatus(90)', '监控在线状态更新 总共耗时：40毫秒', '0', '', '2025-09-26 15:08:00');
INSERT INTO `sys_job_log` VALUES (13, '设备定时同步', 'SYSTEM', 'deviceJob.syncDeviceStatus', '设备定时同步 总共耗时：4毫秒', '0', '', '2025-09-26 15:09:00');
...
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES (1, '系统管理', 0, 5, 'system', NULL, '', 1, 0, 'M', '0', '0', '', 'system', 'admin', '2021-12-15 21:36:18', 'admin', '2025-09-26 15:09:11', '系统管理目录');
INSERT INTO `sys_menu` VALUES (2, '系统监控', 0, 6, 'monitor', NULL, '', 1, 0, 'M', '0', '0', '', 'monitor', 'admin', '2021-12-15 21:36:18', 'admin', '2025-09-26 15:09:06', '系统监控目录');
INSERT INTO `sys_menu` VALUES (3, '系统工具', 0, 7, 'tool', NULL, '', 1, 0, 'M', '0', '0', '', 'tool', 'admin', '2021-12-15 21:36:18', 'admin', '2025-09-26 15:09:02', '系统工具目录');
...
INSERT INTO `sys_menu` VALUES (2000, '设备管理', 0, 1, 'iot', NULL, NULL, 1, 0, 'M', '0', '0', '', 'device', 'admin', '2021-12-15 23:57:06', 'admin', '2025-09-26 15:10:55', '');
INSERT INTO `sys_menu` VALUES (2001, '产品分类', 3063, 2, 'category', 'iot/category/index', NULL, 1, 0, 'C', '0', '0', 'iot:category:list', 'category', 'admin', '2021-12-16 00:40:02', 'admin', '2025-09-26 15:10:31', '产品分类菜单');
...
INSERT INTO `sys_menu` VALUES (2007, '设备管理', 2000, 5, 'device', 'iot/device/index', NULL, 1, 0, 'C', '0', '0', 'iot:device:list', 'iot', 'admin', '2021-12-16 00:40:12', 'admin', '2025-09-26 15:11:09', '设备菜单');
...
INSERT INTO `sys_menu` VALUES (2043, '产品管理', 3063, 3, 'product', 'iot/product/index', NULL, 1, 0, 'C', '0', '0', 'iot:product:list', 'product', 'admin', '2021-12-16 00:41:18', 'admin', '2025-09-26 15:10:37', '产品菜单');
...
INSERT INTO `sys_menu` VALUES (2049, '通用物模型', 3063, 1, 'template', 'iot/template/index', NULL, 1, 0, 'C', '0', '0', 'iot:template:list', 'model', 'admin', '2021-12-16 00:41:28', 'admin', '2025-09-26 15:10:25', '通用物模型菜单');
...
INSERT INTO `sys_menu` VALUES (3031, 'Netty管理', 0, 4, 'netty', NULL, NULL, 1, 0, 'M', '0', '0', '', 'mq', 'admin', '2022-02-26 00:42:12', 'admin', '2025-09-26 15:09:16', '');
...
INSERT INTO `sys_menu` VALUES (3050, '规则引擎', 0, 3, 'ruleengine', NULL, NULL, 1, 0, 'M', '0', '0', '', 'channel', 'admin', '2024-04-22 16:28:15', 'admin', '2025-09-26 15:09:20', '');
...
CREATE TABLE `sys_oper_log`  (
  `oper_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '操作日志ID',
...
-- ----------------------------
INSERT INTO `sys_oper_log` VALUES (1, '菜单管理', 3, 'com.gyjiot.web.controller.system.SysMenuController.remove()', 'DELETE', 1, 'admin', '研发部门', '/system/menu/2124', '127.0.0.1', '内网IP', '2124', '{\"msg\":\"菜单已分配,不允许删除\",\"code\":601}', 0, NULL, '2025-09-26 15:05:42', 0);
INSERT INTO `sys_oper_log` VALUES (2, '角色管理', 2, 'com.gyjiot.web.controller.system.SysRoleController.edit()', 'PUT', 1, 'admin', '研发部门', '/system/role', '127.0.0.1', '内网IP', '{\"admin\":false,\"createTime\":\"2022-06-10 13:54:29\",\"dataScope\":\"1\",\"delFlag\":\"0\",\"deptCheckStrictly\":true,\"flag\":false,\"menuCheckStrictly\":true,\"menuIds\":[2000,3031,1,2049,2050,2051,2052,2053,2054,3033,3034,3035,3036,3037,3038,2001,2002,2003,2004,2005,2006,2043,2044,2045,2046,2047,2048,2140,2136,2137,2138,2139,2019,2020,2021,2022,2023,2024,2007,2008,2009,2010,2011,2012,2147,2148,3032,100,1001,1002,1003,1004,1005,1006,1007,101,1008,1009,1010,1011,1012,102,1013,1014,1015,1016,103,1017,1018,1019,1020,104,1021,1022,1023,1024,1025,105,1026,1027,1028,1029,1030,106,1031,1032,1033,1034,1035,107,1036,1037,1038,1039,108,500,1040,1041,1042,501,1043,1044,1045,1065,2,109,1046,1047,1048,110,1049,1050,1051,1052,1053,1054,111,112,113,124,3,114,115,1055,1056,1058,1057,1059,1060,116,4],\"pageNum\":1,\"pageSize\":2147483647,\"params\":{},\"remark\":\"普通管理员\",\"roleId\":5,\"roleKey\":\"manager\",\"roleName\":\"管理员\",\"roleSort\":5,\"status\":\"0\",\"updateBy\":\"admin\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-09-26 15:06:02', 0);
INSERT INTO `sys_oper_log` VALUES (3, '角色管理', 2, 'com.gyjiot.web.controller.system.SysRoleController.edit()', 'PUT', 1, 'admin', '研发部门', '/system/role', '127.0.0.1', '内网IP', '{\"admin\":false,\"createTime\":\"2021-12-16 16:44:30\",\"dataScope\":\"1\",\"delFlag\":\"0\",\"deptCheckStrictly\":true,\"flag\":false,\"menuCheckStrictly\":true,\"menuIds\":[2000,2049,3033,2001,2043,2019,2007,3031,1,100,101,102,103,104,105,106,107,108,500,501,2,109,110,3,115,2050,2051,3034,3035,2002,2003,2044,2045,2136,2137,2020,2021,2008,2009,2147,2148,3032,1001,1008,1013,1017,1021,1026,1031,1036,1040,1043,1046,1049,111,112,113,114,1055,116,4],\"pageNum\":1,\"pageSize\":2147483647,\"params\":{},\"remark\":\"只能查询和新增系统数据\",\"roleId\":4,\"roleKey\":\"visitor\",\"roleName\":\"游客\",\"roleSort\":4,\"status\":\"0\",\"updateBy\":\"admin\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-09-26 15:06:10', 0);
INSERT INTO `sys_oper_log` VALUES (4, '角色管理', 2, 'com.gyjiot.web.controller.system.SysRoleController.edit()', 'PUT', 1, 'admin', '研发部门', '/system/role', '127.0.0.1', '内网IP', '{\"admin\":false,\"createTime\":\"2021-12-15 21:36:18\",\"dataScope\":\"5\",\"delFlag\":\"0\",\"deptCheckStrictly\":true,\"flag\":false,\"menuCheckStrictly\":true,\"menuIds\":[2000,1,107,2019,2020,2021,2022,2023,2024,2007,2008,2009,2010,2011,2012,2147,2148,1036,4],\"pageNum\":1,\"pageSize\":2147483647,\"params\":{},\"remark\":\"设备的最终用户，只能管理设备和分组\",\"roleId\":3,\"roleKey\":\"general\",\"roleName\":\"普通用户\",\"roleSort\":3,\"status\":\"0\",\"updateBy\":\"admin\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-09-26 15:06:16', 0);
INSERT INTO `sys_oper_log` VALUES (5, '角色管理', 2, 'com.gyjiot.web.controller.system.SysRoleController.edit()', 'PUT', 1, 'admin', '研发部门', '/system/role', '127.0.0.1', '内网IP', '{\"admin\":false,\"createTime\":\"2021-12-16 16:41:30\",\"dataScope\":\"5\",\"delFlag\":\"0\",\"deptCheckStrictly\":true,\"flag\":false,\"menuCheckStrictly\":true,\"menuIds\":[2000,1,107,2049,2050,2051,2052,2053,2054,2001,2002,2003,2004,2005,2006,2043,2044,2045,2046,2047,2048,2140,2136,2137,2138,2139,2019,2020,2021,2022,2023,2024,2007,2008,2009,2010,2011,2012,2147,2148,1036,4],\"pageNum\":1,\"pageSize\":2147483647,\"params\":{},\"remark\":\"管理产品和设备\",\"roleId\":2,\"roleKey\":\"tenant\",\"roleName\":\"设备租户\",\"roleSort\":2,\"status\":\"0\",\"updateBy\":\"admin\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-09-26 15:06:24', 0);
INSERT INTO `sys_oper_log` VALUES (6, '菜单管理', 3, 'com.gyjiot.web.controller.system.SysMenuController.remove()', 'DELETE', 1, 'admin', '研发部门', '/system/menu/2124', '127.0.0.1', '内网IP', '2124', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-09-26 15:06:33', 0);
INSERT INTO `sys_oper_log` VALUES (7, '菜单管理', 3, 'com.gyjiot.web.controller.system.SysMenuController.remove()', 'DELETE', 1, 'admin', '研发部门', '/system/menu/2126', '127.0.0.1', '内网IP', '2126', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-09-26 15:06:35', 0);
INSERT INTO `sys_oper_log` VALUES (8, '菜单管理', 3, 'com.gyjiot.web.controller.system.SysMenuController.remove()', 'DELETE', 1, 'admin', '研发部门', '/system/menu/2127', '127.0.0.1', '内网IP', '2127', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-09-26 15:06:37', 0);
INSERT INTO `sys_oper_log` VALUES (9, '菜单管理', 3, 'com.gyjiot.web.controller.system.SysMenuController.remove()', 'DELETE', 1, 'admin', '研发部门', '/system/menu/2128', '127.0.0.1', '内网IP', '2128', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-09-26 15:06:39', 0);
INSERT INTO `sys_oper_log` VALUES (10, '菜单管理', 3, 'com.gyjiot.web.controller.system.SysMenuController.remove()', 'DELETE', 1, 'admin', '研发部门', '/system/menu/2125', '127.0.0.1', '内网IP', '2125', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-09-26 15:06:42', 0);
INSERT INTO `sys_oper_log` VALUES (11, '菜单管理', 3, 'com.gyjiot.web.controller.system.SysMenuController.remove()', 'DELETE', 1, 'admin', '研发部门', '/system/menu/2123', '127.0.0.1', '内网IP', '2123', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-09-26 15:06:45', 0);
INSERT INTO `sys_oper_log` VALUES (12, '菜单管理', 3, 'com.gyjiot.web.controller.system.SysMenuController.remove()', 'DELETE', 1, 'admin', '研发部门', '/system/menu/2130', '127.0.0.1', '内网IP', '2130', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-09-26 15:06:48', 0);
INSERT INTO `sys_oper_log` VALUES (13, '菜单管理', 3, 'com.gyjiot.web.controller.system.SysMenuController.remove()', 'DELETE', 1, 'admin', '研发部门', '/system/menu/2131', '127.0.0.1', '内网IP', '2131', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-09-26 15:06:51', 0);
INSERT INTO `sys_oper_log` VALUES (14, '菜单管理', 3, 'com.gyjiot.web.controller.system.SysMenuController.remove()', 'DELETE', 1, 'admin', '研发部门', '/system/menu/2132', '127.0.0.1', '内网IP', '2132', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-09-26 15:06:53', 0);
INSERT INTO `sys_oper_log` VALUES (15, '菜单管理', 3, 'com.gyjiot.web.controller.system.SysMenuController.remove()', 'DELETE', 1, 'admin', '研发部门', '/system/menu/2133', '127.0.0.1', '内网IP', '2133', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-09-26 15:06:55', 0);
INSERT INTO `sys_oper_log` VALUES (16, '菜单管理', 3, 'com.gyjiot.web.controller.system.SysMenuController.remove()', 'DELETE', 1, 'admin', '研发部门', '/system/menu/2134', '127.0.0.1', '内网IP', '2134', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-09-26 15:06:58', 0);
INSERT INTO `sys_oper_log` VALUES (17, '菜单管理', 3, 'com.gyjiot.web.controller.system.SysMenuController.remove()', 'DELETE', 1, 'admin', '研发部门', '/system/menu/2129', '127.0.0.1', '内网IP', '2129', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-09-26 15:07:02', 0);
INSERT INTO `sys_oper_log` VALUES (18, '菜单管理', 2, 'com.gyjiot.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', '研发部门', '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"createTime\":\"2021-12-15 21:36:18\",\"icon\":\"tool\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":3,\"menuName\":\"系统工具\",\"menuType\":\"M\",\"orderNum\":7,\"pageNum\":1,\"pageSize\":2147483647,\"params\":{},\"parentId\":0,\"path\":\"tool\",\"perms\":\"\",\"query\":\"\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-09-26 15:09:02', 0);
INSERT INTO `sys_oper_log` VALUES (19, '菜单管理', 2, 'com.gyjiot.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', '研发部门', '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"createTime\":\"2021-12-15 21:36:18\",\"icon\":\"monitor\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2,\"menuName\":\"系统监控\",\"menuType\":\"M\",\"orderNum\":6,\"pageNum\":1,\"pageSize\":2147483647,\"params\":{},\"parentId\":0,\"path\":\"monitor\",\"perms\":\"\",\"query\":\"\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-09-26 15:09:06', 0);
INSERT INTO `sys_oper_log` VALUES (20, '菜单管理', 2, 'com.gyjiot.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', '研发部门', '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"createTime\":\"2021-12-15 21:36:18\",\"icon\":\"system\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":1,\"menuName\":\"系统管理\",\"menuType\":\"M\",\"orderNum\":5,\"pageNum\":1,\"pageSize\":2147483647,\"params\":{},\"parentId\":0,\"path\":\"system\",\"perms\":\"\",\"query\":\"\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-09-26 15:09:11', 0);
INSERT INTO `sys_oper_log` VALUES (21, '菜单管理', 2, 'com.gyjiot.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', '研发部门', '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"createTime\":\"2022-02-26 00:42:12\",\"icon\":\"mq\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":3031,\"menuName\":\"Netty管理\",\"menuType\":\"M\",\"orderNum\":4,\"pageNum\":1,\"pageSize\":2147483647,\"params\":{},\"parentId\":0,\"path\":\"netty\",\"perms\":\"\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-09-26 15:09:16', 0);
INSERT INTO `sys_oper_log` VALUES (22, '菜单管理', 2, 'com.gyjiot.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', '研发部门', '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"createTime\":\"2024-04-22 16:28:15\",\"icon\":\"channel\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":3050,\"menuName\":\"规则引擎\",\"menuType\":\"M\",\"orderNum\":3,\"pageNum\":1,\"pageSize\":2147483647,\"params\":{},\"parentId\":0,\"path\":\"ruleengine\",\"perms\":\"\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-09-26 15:09:20', 0);
INSERT INTO `sys_oper_log` VALUES (23, '菜单管理', 2, 'com.gyjiot.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', '研发部门', '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"createTime\":\"2024-07-15 14:42:13\",\"icon\":\"live\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":3058,\"menuName\":\"视频中心\",\"menuType\":\"M\",\"orderNum\":2,\"pageNum\":1,\"pageSize\":2147483647,\"params\":{},\"parentId\":0,\"path\":\"video\",\"perms\":\"\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-09-26 15:09:24', 0);
INSERT INTO `sys_oper_log` VALUES (24, '菜单管理', 2, 'com.gyjiot.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', '研发部门', '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"createTime\":\"2021-12-15 23:57:06\",\"icon\":\"iot\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2000,\"menuName\":\"设备管理\",\"menuType\":\"M\",\"orderNum\":1,\"pageNum\":1,\"pageSize\":2147483647,\"params\":{},\"parentId\":0,\"path\":\"iot\",\"perms\":\"\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-09-26 15:09:30', 0);
INSERT INTO `sys_oper_log` VALUES (25, '菜单管理', 1, 'com.gyjiot.web.controller.system.SysMenuController.add()', 'POST', 1, 'admin', '研发部门', '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"createBy\":\"admin\",\"icon\":\"example\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuName\":\"产品管理\",\"menuType\":\"M\",\"orderNum\":0,\"pageNum\":1,\"pageSize\":2147483647,\"params\":{},\"parentId\":0,\"path\":\"prod\",\"status\":\"0\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-09-26 15:10:06', 0);
INSERT INTO `sys_oper_log` VALUES (26, '菜单管理', 2, 'com.gyjiot.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', '研发部门', '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"component\":\"iot/template/index\",\"createTime\":\"2021-12-16 00:41:28\",\"icon\":\"model\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2049,\"menuName\":\"通用物模型\",\"menuType\":\"C\",\"orderNum\":1,\"pageNum\":1,\"pageSize\":2147483647,\"params\":{},\"parentId\":3063,\"path\":\"template\",\"perms\":\"iot:template:list\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-09-26 15:10:25', 0);
INSERT INTO `sys_oper_log` VALUES (27, '菜单管理', 2, 'com.gyjiot.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', '研发部门', '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"component\":\"iot/category/index\",\"createTime\":\"2021-12-16 00:40:02\",\"icon\":\"category\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2001,\"menuName\":\"产品分类\",\"menuType\":\"C\",\"orderNum\":2,\"pageNum\":1,\"pageSize\":2147483647,\"params\":{},\"parentId\":3063,\"path\":\"category\",\"perms\":\"iot:category:list\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-09-26 15:10:31', 0);
...
INSERT INTO `sys_role` VALUES (2, '设备租户', 'tenant', 2, '5', 1, 1, '0', '0', 'admin', '2021-12-16 16:41:30', 'admin', '2025-09-26 15:06:24', '管理产品和设备');
INSERT INTO `sys_role` VALUES (3, '普通用户', 'general', 3, '5', 1, 1, '0', '0', 'admin', '2021-12-15 21:36:18', 'admin', '2025-09-26 15:06:16', '设备的最终用户，只能管理设备和分组');
INSERT INTO `sys_role` VALUES (4, '游客', 'visitor', 4, '1', 1, 1, '0', '0', 'admin', '2021-12-16 16:44:30', 'admin', '2025-09-26 15:06:10', '只能查询和新增系统数据');
INSERT INTO `sys_role` VALUES (5, '管理员', 'manager', 5, '1', 1, 1, '0', '0', 'admin', '2022-06-10 13:54:29', 'admin', '2025-09-26 15:06:02', '普通管理员');
